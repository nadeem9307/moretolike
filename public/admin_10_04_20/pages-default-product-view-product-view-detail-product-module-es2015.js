...
let ViewDetailProductComponent = class ViewDetailProductComponent {
        ...
        this.route.params.subscribe(params => {
            if (params.product_id) {
                ...
                this._productService.getById(this.product_id).subscribe(data => {
                    ...
                    this.product_img = data.success.product_img;
                    this.selectedBrand = data.success.brand_id;
                    this.productImgUrl = data.success.product_img;
                    ...
                    this.selectedAdminCommisionType = data.success.admin_commission_type;
                    this.admin_commission = data.success.admin_commission;
                    this.selectedVendorCommisionType = data.success.vendor_commission_type;
...
let ViewDetailProductModule = class ViewDetailProductModule {
};
...
//# sourceMappingURL=pages-default-product-view-product-view-detail-product-module-es2015.js.map