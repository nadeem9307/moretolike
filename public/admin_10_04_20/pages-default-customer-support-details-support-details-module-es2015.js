...
let SupportDetailsComponent = class SupportDetailsComponent {
    constructor(toastr, router, _dataService, route, _supportService) {
        this.toastr = toastr;
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            ...
            this._supportService.getById(params.id).subscribe(data => {
                this.supportDetails = data.success;
            });
        });
    }
};
...
let SupportDetailsModule = class SupportDetailsModule {
};
...
//# sourceMappingURL=pages-default-customer-support-details-support-details-module-es2015.js.map