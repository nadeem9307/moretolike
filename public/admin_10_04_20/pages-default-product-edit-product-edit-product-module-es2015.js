...
let EditProductComponent = class EditProductComponent {
    constructor(imgBaseUrl, toastr, route, router, _dataService, _brandService, _menuService, _categoryService, _productService, _subCategory, _script, formBuilder) {
    ...
    ngOnInit() {
        ...
        this._categoryService.getAll().subscribe(data => {
            this.categories_for_ass = data.success;
        });
        ...
        this.route.params.subscribe(params => {
            if (params.product_id) {
                ...
                this._productService.getById(this.product_id).subscribe(data => {
                    //console.log(data.success);
                    this._productService.getTagForDropDown().subscribe(data_tag => {
                        this.dropdownList = data_tag.success;
                        this.selectedItems = JSON.parse(data.success.specification);
                    ...
                    this._productService.getAttributeWithProById(this.product_id).subscribe(data_attr => {
                        this.custom_attribite_list = (data_attr.success);
                        this.attsLoaded = true;
                    });
                    // console.log(JSON.parse(this.custom_attribite_list1));
                    //console.log('product_data_from server' data);
                    this.id = data.success.product_id;
                    // console.log(this.id);
                    //attibutes
                    ...
                    //  console.log(data.success.brand_id)
                    //attibutes
                    this.weight = data.success.weight;
                    this.length = data.success.length;
                    this.width = data.success.width;
                    this.height = data.success.height;
                    this.o_length = data.success.o_length;
                    this.o_width = data.success.o_width;
                    this.o_height = data.success.o_height;
                    this.sku = data.success.sku;
                    this.product_name = data.success.product_name;
                    this.shareable_product = data.success.shareable_product;
                    this.category = data.success.category;
                    this.brand_id = data.success.brand_id;
                    this.old_product_img = data.success.product_img;
                    this.actual_price = data.success.actual_price;
                    this.mrp = data.success.mrp;
                    this.e_review = data.success.e_review;
                    this.product_status = data.success.status;
                    this.product_status = data.success.status;
                    this.purchase_note = data.success.purchase_note;
                    this.discount_minimum_quantity = data.success.discount_minimum_quantity;
                    this.product_details = data.success.product_details;
                    this.current_price = data.success.current_price;
                    this.description = data.success.description;
                    this.total_stock_quantity = data.success.total_stock_quantity;
                    this.stock_quantity = data.success.stock_quantity;
                    this.selectedAvilability = data.success.availability;
                    this.admin_commission_type = data.success.admin_commission_type;
                    this.discount_per = data.success.discount_per;
                    this.admin_commission = data.success.admin_commission;
                    this.vendor_commission_type = data.success.vendor_commission_type;
                    this.vendor_commission = data.success.vendor_commission;
                    ...
                    this._productService.getTag(params.product_id).subscribe(data => {
                        // console.log(params.product_id);
                        this.tagData = data.success;
                        this.noOfPage = data.success.length;
                        // console.log('getTag', data.success);
                    });
                    this._productService.getAttribute(params.product_id).subscribe(data => {
                    ...
                    this._productService.productTypeList(params.product_id).subscribe(data => {
                        this.productTypeList = data.success;
                        //console.log('productTypeList', this.productTypeList);
                    });
                    this._productService.productSubCatList(params.product_id).subscribe(data => {
                        this.subCategories = data.success;
                        //console.log('productTypeList', this.productTypeList);
                    });
                    this._productService.productaccessList(params.product_id).subscribe(data => {
                        this.accessData = data.success;
                        if (this.accessData.length > 0) {
                            this.accessData_bool = 1;
                        }
        ...
        this._productService.getAttributeList().subscribe(data => {
            this.attributeOptions = data.success;
        });
 ...
 */
    ...
    get_product() {
        this._productService.get_product({ category_id: this.selectedCategories }).subscribe(data => {
    ...
    onSubmit() {
        ...
        if (this.form.value.product_name != "" && this.form.value.availability) {
            this._productService.updateProduct(input).subscribe(data => {
                this.product_id = data.success;
                this.toastr.success('Product Update Successfully', 'Success Message');
                this.reset();
    ...
    accessDelete(del_id) {
        ...
        let value = confirm('Are you want to delete this accessories ?');
        if (value) {
            this._productService.accessDelete(del_id).subscribe(data => {
                this.accessData = data.success;
                if (this.accessData.length > 0) {
                    this.accessData_bool = 1;
                }
    ...
    productSubCatDelete(del_id) {
        console.log('productSubCatDelete', del_id);
        let value = confirm('Are you want to delete this Product Sub Category ?');
        if (value) {
            this._productService.productSubCatDelete(del_id).subscribe(data => {
                this.subCategories = data.success;
                // console.log('Access Data', this.accessData);
            });
        }
    }
    productTypeDel(del_id) {
        console.log('productTypeDel', del_id);
        let value = confirm('Are you want to delete this Product Type ?');
        if (value) {
            this._productService.productTypeDel(del_id).subscribe(data => {
                this.productTypeList = data.success;
                // console.log('Access Data', this.accessData);
            });
        }
    ...
    removeAttribute(attribute_id) {
        let temp = [];
        this.custom_attribite_list.forEach(data => {
        ...
        if (this.custom_attribite_list.length) {
            this._productService.addAttributeList({ "product_id": this.product_id, "form_data": this.custom_attribite_list }).subscribe(data => {
                //console.log(data);
                this.toastr.success('You have successfully updated product attributes.', 'Success Message');
            });
        }
    }
    addAttribute() {
        ...
        if (this.attributes != '') {
            if (this.custom_attribite_list == null) {
                ...
                this.custom_attribite_list.forEach(data => {
                    if (data.id == this.attributes) {
                        counter = 0;
                    }
                });
            }
            if (counter == 1) {
                this._productService.getAttributeById(parseInt(this.attributes), parseInt(this.product_id)).subscribe(data => {
                    let testObj = { "id": data.success.id, "name": data.success.name, "data": JSON.parse(data.success.data) };
                    this.custom_attribite_list.push(testObj);
                });
            }
            else {
    ...
    saveAccesories() {
        if (this.selectedProduct != '') {
            let input = { form_data: { 'fk_category': this.selectedCategories, 'fk_sub_cat': '', 'accessory_product_id': this.selectedProduct, 'fk_acc_product_id': this.product_id, 'fk_user_id': this.currentUser.success.id } };
            this._productService.addProductAccess(input).subscribe(data => {
                //this.reset();
                this._productService.productaccessList(this.product_id).subscribe(data => {
                    this.accessData = data.success;
                    if (this.accessData.length > 0) {
                        this.accessData_bool = 1;
                        this.toastr.success('You have successfully selected product.', 'Success Message');
                    }
                    console.log('Access Data', this.accessData);
                });
            });
...
let EditProductModule = class EditProductModule {
};
...
//# sourceMappingURL=pages-default-product-edit-product-edit-product-module-es2015.js.map