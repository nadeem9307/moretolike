...
/***/ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/customer/support-list/support-list.component.html":
/*!*****************************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/theme/pages/default/customer/support-list/support-list.component.html ***!
  \*****************************************************************************************************************/
...
/* harmony import */ var _auth_services_staff_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../auth/_services/staff.service */ "./src/app/auth/_services/staff.service.ts");
...
let SupportListComponent = class SupportListComponent {
    constructor(_staffService, _supportService, toastr, router, formBuilder) {
    ...
    ngOnInit() {
        ...
        this.form = this.formBuilder.group({
            assign_to: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
        });
    ...
    getSupport() {
        this._supportService.getAll().subscribe(data => {
            this.supportData = data.success;
        });
    }
    staff() {
        this._staffService.getAll().subscribe(data => {
            this.staffData = data.success;
        });
    }
    /*public search() {
    ...
    assignTo() {
        let assignToid = parseInt(this.form.value.assign_to);
        let sp_id = this.sp_id;
        let data = {
            "assignToid": assignToid,
            "sp_id": sp_id
        };
        this._supportService.assignTo(data).subscribe(data => {
            this.staff_name = data.success.f_name + ' ' + data.success.l_name;
            this.getSupport();
            this.toastr.success('Staff assign Successfully', 'Success Message');
        });
    }
    onChangePriority(e) {
        console.log(e.target.value);
        this._supportService.priorityUpdate(this.sp_id, e.target.value).subscribe(data => {
            console.log(data);
            this.staff_name = data.success.f_name + ' ' + data.success.l_name;
            this.getSupport();
    ...
    onStatus() {
        ...
        let status = parseInt(this.formStatus.value.status);
        this._supportService.updateStatus(this.sp_id, status).subscribe(data => {
            console.log(data);
            this.getSupport();
            this.toastr.success('Status updated Successfully', 'Success Message');
        });
    }
    sendMessage() {
        ...
        this._supportService.sendMessage(this.sp_id, data).subscribe(data => {
            this.getChat(this.sp_id);
            this.reset();
            //console.log(data);
            /*this.staff_name = data.success.f_name+' '+data.success.l_name;
            this.getSupport();*/
            this.toastr.success('Message sent Successfully', 'Success Message');
        });
    }
    reset() {
    ...
    getChat(sp_id) {
        this._supportService.getChat(sp_id).subscribe(data => {
            //console.log(data.success);
            this.chats = data.success;
            var dd = JSON.parse(localStorage.getItem('currentUser'));
            this.logged_user_id = dd.success.id;
            //this.toastr.success('Priority updated Successfully', 'Success Message');
        });
    }
};
SupportListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: __webpack_require__(/*! raw-loader!./support-list.component.html */ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/customer/support-list/support-list.component.html"),
        providers: [_auth_services_staff_service__WEBPACK_IMPORTED_MODULE_3__["StaffService"]]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_auth_services_staff_service__WEBPACK_IMPORTED_MODULE_3__["StaffService"], _auth_services_support_service__WEBPACK_IMPORTED_MODULE_2__["SupportService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"]])
...
/* harmony import */ var _support_list_support_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../support-list/support-list.component */ "./src/app/theme/pages/default/customer/support-list/support-list.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: "",
                component: _support_list_support_list_component__WEBPACK_IMPORTED_MODULE_3__["SupportListComponent"]
            }
        ]
    },
];
let SupportListModule = class SupportListModule {
};
SupportListModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_support_list_support_list_component__WEBPACK_IMPORTED_MODULE_3__["SupportListComponent"]]
    })
], SupportListModule);
...
//# sourceMappingURL=pages-default-customer-support-list-support-list-module-es2015.js.map