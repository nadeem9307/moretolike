...
/***/ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/order/order-list/order-list.component.html":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/theme/pages/default/order/order-list/order-list.component.html ***!
  \**********************************************************************************************************/
...
/* harmony import */ var _auth_services_user_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../auth/_services/user.service */ "./src/app/auth/_services/user.service.ts");
...
let OrderListComponent = class OrderListComponent {
    constructor(toastr, _userService, route, router, _orderService, _dataService, formBuilder) {
        this.toastr = toastr;
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(parameter => {
            ...
            if (parameter.vendor_id) {
                ...
                this._userService.getById(parameter.vendor_id).subscribe(data => {
                    this.pageTilte = data.success.store_name + '\'s Order';
                    this.back_btn = true;
                });
            }
            else {
            ...
            this._orderService.getAll(where).subscribe(data => {
                this.brandData = data.success;
                this.allOrder = this.brandData.length;
                this.statusOrderData('completed');
                this.statusOrderData('processing');
                this.statusOrderData('on_hold');
                this.statusOrderData('pending');
                this.statusOrderData('cancelled');
                this.statusOrderData('refunded');
            }, (err) => {
                console.log('Sorry We have not found any product');
            });
        });
    }
    statusOrderData(status, filter = false) {
        let order_data = [];
    ...
    orderFilter() {
        let loggedUserId = JSON.parse(localStorage.getItem('currentUser'));
        this._orderService.filter({ search_value: this.searchValue, dropdown_value: this.dropDownValue, loggedUserId: loggedUserId.success.id, loggedUserRole: loggedUserId.success.role }).subscribe(data => {
            this.brandData = data.success;
        });
    }
    checkAll(ev, brandData) {
        brandData.forEach(x => x.state = ev.target.checked);
    }
    isAllChecked(brandData) {
        return brandData.every(_ => _.state);
    }
    filterByCustomer() {
        let order_data = [];
        if (this.customer_name == '') {
            ...
            this.brandData.forEach(obj => {
                if (obj.customer_name != '' && obj.customer_name != null && obj.customer_name != undefined) {
                    if (obj.customer_name.replace(/<[^>]*>/g, "").toUpperCase().indexOf(this.customer_name.toUpperCase()) > -1) {
                        //console.log(obj);
                        order_data.push(obj);
                    }
                }
    ...
    filterByDate() {
        ...
        if (this.filterDate == '') {
            ...
            this.brandData.forEach(obj => {
                ...
                if (created_date[0] == this.filterDate) {
                    order_data.push(obj);
                }
            });
            this.brandData = order_data;
    ...
    bulkAction(brandData) {
        ...
        this._orderService.updateStatus({ cart_id: cart_data, status: this.bulkActionData }).subscribe(data => {
            console.log('data');
            console.log(data);
    ...
    getAllOrderList() {
        ...
        this.route.params.subscribe(parameter => {
            ...
            this._orderService.getAll(where).subscribe(data => {
                this.brandData = data.success;
                this.filterDataHolder = undefined;
                this.statusOrderData('completed');
                this.statusOrderData('processing');
                this.statusOrderData('on_hold');
                this.statusOrderData('pending');
...
OrderListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: __webpack_require__(/*! raw-loader!./order-list.component.html */ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/order/order-list/order-list.component.html")
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"], _auth_services_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _auth_services_order_service__WEBPACK_IMPORTED_MODULE_2__["OrderService"], _services_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])
], OrderListComponent);
...
/* harmony import */ var _order_list_order_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../order-list/order-list.component */ "./src/app/theme/pages/default/order/order-list/order-list.component.ts");
...
//# sourceMappingURL=pages-default-order-order-list-order-list-module-es2015.js.map