(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-default-reports-inventory-inventory-module"],{
...
/***/ "./node_modules/ngx-daterangepicker-material/esm2015/ngx-daterangepicker-material.js":
/*!*******************************************************************************************!*\
  !*** ./node_modules/ngx-daterangepicker-material/esm2015/ngx-daterangepicker-material.js ***!
  \*******************************************************************************************/
...
`,
                ...
                providers: [{
                        ...
                        useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(() => DaterangepickerComponent),
                        multi: true
                    }]
            },] },
];
...
DaterangepickerDirective.decorators = [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"], args: [{
                ...
                providers: [
                    {
                        provide: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NG_VALUE_ACCESSOR"],
                        useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(() => DaterangepickerDirective), multi: true
                    }
                ]
            },] },
];
...
/***/ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/reports/inventory/inventory.component.html":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/theme/pages/default/reports/inventory/inventory.component.html ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"m-portlet m-portlet--mobile\">\n\t\t<div class=\"m-portlet__body\">\n\t\t\t<div class=\"m-portlet__head\">\n\t\t\t\t<div class=\"m-portlet__head-caption\">\n\t\t\t\t\t<div class=\"m-portlet__head-title\">\n\t\t\t\t\t\t<span class=\"m-portlet__head-icon m--hide\"><i class=\"la la-gear\"></i></span>\n\t\t\t\t\t\t<h3 class=\"m-portlet__head-text\">Product Inventory</h3>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div>\n\t\t\t <span class=\"m-subheader__daterange\">\n\t\t\t\t<span class=\"m-subheader__daterange-label\">\n\t\t\t\t\t<span class=\"m-subheader__daterange-title\"></span>\n\t\t\t\t\t<input type=\"text\" [(ngModel)]=\"selected\" [alwaysShowCalendars]=\"true\" [ranges]=\"ranges\"  placeholder=\"Choose date\" (change)=\"changeDate($event)\" ngxDaterangepickerMd style=\"border: none;\">\n\t\t\t\t</span>\n\t\t\t\t<a href=\"#\" class=\"btn btn-sm btn-brand m-btn m-btn--icon m-btn--icon-only m-btn--custom m-btn--pill\">\n\t\t\t\t\t<i class=\"la la-angle-down\"></i>\n\t\t\t\t</a>\n\t\t\t</span> \n\t\t</div>\n\t\t\t</div>\n\n\t\t\t<div class=\"m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30\">\n\t\t\t\t<div class=\"row align-items-center\">\n\t\t\t\t\t<div class=\"col-xl-12 order-2 order-xl-1\">\n\t\t\t\t\t\t<div class=\"form-group m-form__group row align-items-center\">\n\n\t\t\t\t\t\t\t<!-- <div class=\"col-md-3\">\n\t\t\t\t\t\t\t\t<div class=\"m-form__group m-form__group--inline\">\n\t\t\t\t\t\t\t\t\t<div class=\"m-form__label\">\n\t\t\t\t\t\t\t\t\t\t<label class=\"m-label m-label--single\">\n\t\t\t\t\t\t\t\t\t\t\tProduct:\n\t\t\t\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t<div class=\"m-form__control\">\n\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" [(ngModel)] = \"dropDownValueSearch\" name=\"search_value\" (change)=\"search();\">\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">All</option>\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"1\">Single Product</option>\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"0\">Grouped Product</option>\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"2\">Shareable Product</option>\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"3\">Added Other Vendor Shareable Product</option>\n\t\t\t\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"d-md-none m--margin-bottom-10\"></div>\n\t\t\t\t\t\t\t</div> -->\n\n\n\t\t\t\t\t\t\t<div class=\"col-md-3\">\n\t\t\t\t\t\t\t\t<div class=\"m-form__group m-form__group--inline\">\n\t\t\t\t\t\t\t\t\t<div class=\"m-form__label\">\n\t\t\t\t\t\t\t\t\t\t<label class=\"m-label m-label--single\">\n\t\t\t\t\t\t\t\t\t\t\tStaus:\n\t\t\t\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t<div class=\"m-form__control\">\n\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" [(ngModel)] = \"dropDownValueStatus\" name=\"dropDownValueStatus\" (change)=\"search();\">\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">All</option>\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"Active\">Active</option>\n\t\t\t\t\t\t\t\t\t\t\t<option value=\"Inactive\">Inactive</option>\n\t\t\t\t\t\t\t\t\t\t</select>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"d-md-none m--margin-bottom-10\"></div>\n\t\t\t\t\t\t\t</div>\n\n\n\t\t\t\t\t\t\t<div class=\"col-md-4\">\n\t\t\t\t\t\t\t\t<div class=\"m-input-icon m-input-icon--left\">\n\t\t\t\t\t\t\t\t<input class=\"form-control m-input  m-input--solid\" id=\"generalSearch\" [(ngModel)] = \"searchValue\" placeholder=\"Search by Name / SKU\" type=\"text\" name=\"search_value\"> \n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\n\n\t\t\t\t\t\t\t<div class=\"col-md-2\">\n\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill\"(click)=\"search();\">\n\t\t\t\t\t\t\t\t\t\t<span>Search</span>\n\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t\t<div class=\"m-separator m-separator--dashed d-xl-none\"></div>\n\t\t\t\t\t\t\t</div>\n\n\n\t\t\t\t\t\t\t<div class=\"col-md-2\">\n\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill\"(click)=\"exportCSV(productData);\">\n\t\t\t\t\t\t\t\t\t\t<span>Export in CSV</span>\n\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t\t<div class=\"m-separator m-separator--dashed d-xl-none\"></div>\n\t\t\t\t\t\t\t</div> \n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t\t\t\n\t\t\t<div class=\"m_datatable m-datatable m-datatable--default m-datatable--loaded\" id=\"m_datatable_latest_orders\" style=\"position: static; zoom: 1;\">\n\t\t\t\t<table class=\"m-datatable__table\" style=\"display: block; min-height: 300px; overflow-x: auto;\">\n\t\t\t\t\t<thead class=\"m-datatable__head\">\n\t\t\t\t\t\t<tr class=\"m-datatable__row\" style=\"left: 0px;\">\n\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t<th data-field=\"Product SKU\" class=\"m-datatable__cell m-datatable__cell--sort\" style=\"\"><span>Product SKU</span>\n\t\t\t\t\t\t\t</th>\n\n\t\t\t\t\t\t\t<th data-field=\"Product Name\" class=\"m-datatable__cell m-datatable__cell--sort\"><span>Product Name</span>\n\t\t\t\t\t\t\t</th>\n\n\t\t\t\t\t\t\t<th data-field=\"Product Brand\" class=\"m-datatable__cell m-datatable__cell--sort\"><span>Total Sale (q)</span>\n\t\t\t\t\t\t\t</th>\n\n\t\t\t\t\t\t\t<th data-field=\"Product Actual Price / MRP\" class=\"m-datatable__cell m-datatable__cell--sort\"><span>Total Sale (m)</span>\n\t\t\t\t\t\t\t</th>\n\n\t\t\t\t\t\t\t<th data-field=\"Shareable Product\" class=\"m-datatable__cell m-datatable__cell--sort\"><span>Stock Quantity</span>\n\t\t\t\t\t\t\t</th>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</thead>\n\t\t\t\t\t<tbody class=\"m-datatable__body\" style=\"\">\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t<tr data-row=\"0\" *ngFor=\"let product of productData | paginate: { itemsPerPage: 10, currentPage: p }\" class=\"m-datatable__row\" style=\"left: 0px;\" routerLink=\"/product/view-product/{{product.product_id}}\" style=\"cursor: pointer;\">\n\n\t\t\t\t\t\t\t\t\t<td data-field=\"ShipName\" class=\"m-datatable__cell\">\n\t\t\t\t\t\t\t\t\t\t<span style=\"width: 110px;\">{{product.sku}}</span>\n\t\t\t\t\t\t\t\t\t</td>\n\n\t\t\t\t\t\t\t\t\t<td data-field=\"Currency\" class=\"m-datatable__cell\">\n\t\t\t\t\t\t\t\t\t\t<span style=\"width: 100px;\">{{product.product_name}}</span>\n\t\t\t\t\t\t\t\t\t</td>\n\n\t\t\t\t\t\t\t\t\t<td data-field=\"ShipAddress\" class=\"m-datatable__cell\">\n\t\t\t\t\t\t\t\t\t\t<span style=\"width: 110px;\">{{product.total_sale_q}}</span>\n\t\t\t\t\t\t\t\t\t</td>\n\n\t\t\t\t\t\t\t\t\t<td data-field=\"ShipDate\" class=\"m-datatable__cell\">\n\t\t\t\t\t\t\t\t\t\t<span style=\"width: 110px;\">{{product.total_sale_m}}</span>\n\t\t\t\t\t\t\t\t\t</td>\n\n\t\t\t\t\t\t\t\t\t<td data-field=\"Latitude\" class=\"m-datatable__cell\">\n\t\t\t\t\t\t\t\t\t\t<span style=\"width: 110px;\">{{product.stock_quantity}}</span>\n\t\t\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t</tbody>\n\t\t\t\t\t</table>\n\t\t\t\t\t<pagination-controls (pageChange)=\"p = $event\"></pagination-controls>\n\t\n\t\t\t\t</div>\n\t\t</div>\n</div>"
...
/***/ "./src/app/theme/pages/default/reports/inventory/inventory.component.ts":
/*!******************************************************************************!*\
  !*** ./src/app/theme/pages/default/reports/inventory/inventory.component.ts ***!
  \******************************************************************************/
...
/* harmony import */ var _auth_services_product_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../auth/_services/product.service */ "./src/app/auth/_services/product.service.ts");
...
let InventoryComponent = class InventoryComponent {
    constructor(router, toastr, _reportsService, route, _brandService, _menuService, _categoryService, _productService, _subCategory, _dataService, _script) {
        this.router = router;
        this.toastr = toastr;
    ...
    ngOnInit() {
        ...
        if (permission.report_inventory != 1) {
        ...
        let loggedUserId;
        let where;
        this.ranges = { 'Today': [moment__WEBPACK_IMPORTED_MODULE_12__(), moment__WEBPACK_IMPORTED_MODULE_12__()], 'Yesterday': [moment__WEBPACK_IMPORTED_MODULE_12__().subtract(1, 'days'), moment__WEBPACK_IMPORTED_MODULE_12__().subtract(1, 'days')], 'Last 7 Days': [moment__WEBPACK_IMPORTED_MODULE_12__().subtract(6, 'days'), moment__WEBPACK_IMPORTED_MODULE_12__()], 'Last 30 Days': [moment__WEBPACK_IMPORTED_MODULE_12__().subtract(29, 'days'), moment__WEBPACK_IMPORTED_MODULE_12__()], 'This Month': [moment__WEBPACK_IMPORTED_MODULE_12__().startOf('month'), moment__WEBPACK_IMPORTED_MODULE_12__().endOf('month')], 'Last Month': [moment__WEBPACK_IMPORTED_MODULE_12__().subtract(1, 'month').startOf('month'), moment__WEBPACK_IMPORTED_MODULE_12__().subtract(1, 'month').endOf('month')] };
        ...
        this.route.params.subscribe(parameter => {
            ...
            this._reportsService.reportInventory(where).subscribe(data => {
    ...
    search() {
        this._reportsService.searching({ search_value: this.searchValue, dropdown_value: this.dropDownValue }).subscribe(data => {
            console.log(data);
    ...
    customer_delete(del_id) {
        console.log(del_id);
        let value = confirm('Are you sure to delete this customer request?');
        if (value) {
            this._reportsService.del_support(del_id).subscribe(data => {
    ...
    changeDate(changeDate) {
        ...
        let user_role = this.currentUser.success.role;
        let end_date = changeDate.endDate.toDate();
        let start_date = changeDate.startDate.toDate();
        this._reportsService.productByDateRange({ start_date: start_date, end_date: end_date, role: user_role, loggedUserId: user_id }).subscribe(data => {
            this.productData = data.success;
        });
    }
    changeStatus(customer) {
        if (customer.customer_status == 'Active') {
            ...
            this._reportsService.updateStatus(customer.id).subscribe(data => {
    ...
    sortReport() {
        console.log('you have going right');
    }
    exportCSV(productData) {
        let ReportTitle = 'Product Inventory Report';
        let ShowLabel = true;
        /*export csv*/
        //If JSONData is not an object then JSON.parse will parse the JSON string in an Object
        var arrData = typeof productData != 'object' ? JSON.parse(productData) : productData;
        var CSV = '';
        ...
        link.download = fileName + Math.random() + ".csv";
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-inventory', ['assets/app/js/inventory.js']);
    }
};
InventoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-inventory',
        template: __webpack_require__(/*! raw-loader!./inventory.component.html */ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/reports/inventory/inventory.component.html"),
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewEncapsulation"].None
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_11__["ToastrService"], _auth_services_reports_service__WEBPACK_IMPORTED_MODULE_1__["ReportsService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"], _auth_services_brand_service__WEBPACK_IMPORTED_MODULE_10__["BrandService"], _auth_services_menu_service__WEBPACK_IMPORTED_MODULE_5__["MenuService"], _auth_services_category_service__WEBPACK_IMPORTED_MODULE_8__["CategoryService"], _auth_services_product_service__WEBPACK_IMPORTED_MODULE_7__["ProductService"], _auth_services_subCategory_service__WEBPACK_IMPORTED_MODULE_9__["SubCategoryService"], _services_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"], _services_script_loader_service__WEBPACK_IMPORTED_MODULE_3__["ScriptLoaderService"]])
], InventoryComponent);
...
/* harmony import */ var _inventory_inventory_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../inventory/inventory.component */ "./src/app/theme/pages/default/reports/inventory/inventory.component.ts");
...
/* harmony import */ var ngx_daterangepicker_material__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ngx-daterangepicker-material */ "./node_modules/ngx-daterangepicker-material/esm2015/ngx-daterangepicker-material.js");
...
InventoryModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _layouts_layout_module__WEBPACK_IMPORTED_MODULE_6__["LayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], ngx_daterangepicker_material__WEBPACK_IMPORTED_MODULE_8__["NgxDaterangepickerMd"], ngx_pagination__WEBPACK_IMPORTED_MODULE_9__["NgxPaginationModule"],
        ],
...
//# sourceMappingURL=pages-default-reports-inventory-inventory-module-es2015.js.map