...
let PermissionComponent = class PermissionComponent {
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            ...
            this._permissionService.getUserPermissionById(params.id).subscribe(data => {
                this.userPermisionData = data.success;
                this.product_list = data.success.product_list;
                ...
                this.product_menu = data.success.product_menu;
                this.product_category = data.success.product_category;
                this.product_subcategory = data.success.product_subcategory;
                this.product_brand = data.success.product_brand;
                this.product_bulkupload = data.success.product_bulkupload;
                this.order_list = data.success.order_list;
                this.order_add = data.success.order_add;
                this.order_edit = data.success.order_edit;
                this.order_delete = data.success.order_delete;
                this.order_deliveries = data.success.order_deliveries;
                this.reviews_list = data.success.reviews_list;
                this.reviews_add = data.success.reviews_add;
                this.reviews_edit = data.success.reviews_edit;
                this.reviews_delete = data.success.reviews_delete;
                this.reviews_approval = data.success.reviews_approval;
                this.withdraw_list = data.success.withdraw_list;
                this.withdraw_add = data.success.withdraw_add;
                this.withdraw_edit = data.success.withdraw_edit;
                this.withdraw_delete = data.success.withdraw_delete;
                this.withdraw_approval = data.success.withdraw_approval;
                this.subscription_list = data.success.subscription_list;
                this.subscription_add = data.success.subscription_add;
                this.subscription_edit = data.success.subscription_edit;
                this.subscription_delete = data.success.subscription_delete;
                this.booking_list = data.success.booking_list;
                this.booking_add = data.success.booking_add;
                this.booking_edit = data.success.booking_edit;
                this.booking_delete = data.success.booking_delete;
                this.support_list = data.success.support_list;
                this.support_add = data.success.support_add;
                this.support_edit = data.success.support_edit;
                this.support_delete = data.success.support_delete;
                this.website_setting = data.success.website_setting;
                this.dropship_list = data.success.dropship_list;
                this.dropship_add = data.success.dropship_add;
                this.dropship_edit = data.success.dropship_edit;
                this.dropship_delete = data.success.dropship_delete;
                this.report_overview = data.success.report_overview;
                this.report_inventory = data.success.report_inventory;
                this.report_salesByDay = data.success.report_salesByDay;
                this.report_topSelling = data.success.report_topSelling;
                this.report_topEarning = data.success.report_topEarning;
...
//# sourceMappingURL=pages-default-user-group-permission-permission-module-es2015.js.map