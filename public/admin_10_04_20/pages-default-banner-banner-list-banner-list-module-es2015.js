...
let BannerListComponent = class BannerListComponent {
    constructor(imgBaseUrl, router, toastr, _bannerService, _dataService, formBuilder) {
    ...
    brand_delete(del_id) {
        ...
        if (value) {
            this._bannerService.bannerDelete(del_id).subscribe(data => {
...
//# sourceMappingURL=pages-default-banner-banner-list-banner-list-module-es2015.js.map