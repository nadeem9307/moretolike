...
let AddAttributeComponent = class AddAttributeComponent {
    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            ...
            this._productService.addAttribute({ form_data: this.form.value }).subscribe(data => {
...
let AddAttributeModule = class AddAttributeModule {
};
...
//# sourceMappingURL=pages-default-attribute-add-attribute-add-attribute-module-es2015.js.map