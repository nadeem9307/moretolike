...
let ShareableProductComponent = class ShareableProductComponent {
    constructor(toastr, _productService, _dataService) {
        this.toastr = toastr;
    ...
    ngOnInit() {
        ...
        this._productService.shareableList({ user_id: this.user }).subscribe(data => {
            this.shareableProductData = data.success;
        });
    }
    addShareableProduct(user_id, product_id) {
        this._productService.addShareableProduct({ user_id: user_id, product_id: product_id }).subscribe(data => {
            this.shareableProductData = data.success;
...
let ShareableProductModule = class ShareableProductModule {
};
...
//# sourceMappingURL=pages-default-product-shareable-products-shareable-product-shareable-product-module-es2015.js.map