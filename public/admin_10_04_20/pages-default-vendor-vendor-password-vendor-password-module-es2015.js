...
let VendorPasswordComponent = class VendorPasswordComponent {
    constructor(imgBaseUrl, router, formBuilder, toastr, route, _dataService, _userService) {
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            ...
            this._userService.getById(params.id).subscribe(data => {
                ...
                this.user_name = data.success.user_name;
            }, error => {
                this.toastr.error('Sorry! we can not connect service', 'Error Message');
            });
        });
    }
    onSubmit() {
        ...
        this._userService.update_username(input).subscribe(data => {
            console.log('data');
            console.log(data);
    ...
    onSubmitPassword() {
        ...
        input.form_data.user_id = this.user_id;
        this._userService.update_password(input).subscribe(data => {
            this.toastr.success(data.success, 'Success Message');
            this.router.navigate(['vendor/vendor-list']);
        }, error => {
            this.toastr.error('Sorry! we can not connect service', 'Error Message');
...
let VendorPasswordModule = class VendorPasswordModule {
};
...
//# sourceMappingURL=pages-default-vendor-vendor-password-vendor-password-module-es2015.js.map