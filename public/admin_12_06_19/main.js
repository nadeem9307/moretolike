...
var map = {
	...
	"./pages/default/angular/ng-bootstrap/ng-bootstrap.module": [
		...
		"pages-default-angular-ng-bootstrap-ng-bootstrap-module~pages-default-withdraw-withdraw-list-withdraw~0a70bfdf",
		"common",
		"pages-default-angular-ng-bootstrap-ng-bootstrap-module"
	],
	...
	"./pages/default/order/order-edit/order-edit.module": [
		"./src/app/theme/pages/default/order/order-edit/order-edit.module.ts",
		"pages-default-order-order-edit-order-edit-module"
	],
	"./pages/default/order/order-list/order-list.module": [
		"./src/app/theme/pages/default/order/order-list/order-list.module.ts",
		"pages-default-order-order-list-order-list-module"
	],
	"./pages/default/order/order-summary/order-summary.module": [
		"./src/app/theme/pages/default/order/order-summary/order-summary.module.ts",
		"pages-default-order-order-summary-order-summary-module"
	],
	"./pages/default/product/add-product/add-product.module": [
		"./src/app/theme/pages/default/product/add-product/add-product.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"pages-default-product-add-product-add-product-module~pages-default-product-edit-product-edit-product~1feedaf4",
		"common",
		"pages-default-product-add-product-add-product-module"
	],
	"./pages/default/product/bulk-upload/bulk-upload.module": [
		"./src/app/theme/pages/default/product/bulk-upload/bulk-upload.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"common",
		"pages-default-product-bulk-upload-bulk-upload-module"
	],
	"./pages/default/product/child-view/child-view.module": [
		"./src/app/theme/pages/default/product/child-view/child-view.module.ts",
		"pages-default-product-child-view-child-view-module"
	],
	"./pages/default/product/edit-product/edit-product.module": [
	...
	"./pages/default/product/shareable-products/shareable-product-detail/shareable-product-detail.module": [
		"./src/app/theme/pages/default/product/shareable-products/shareable-product-detail/shareable-product-detail.module.ts",
		"pages-default-product-shareable-products-shareable-product-detail-shareable-product-detail-module"
	],
	"./pages/default/product/shareable-products/shareable-product/shareable-product.module": [
		"./src/app/theme/pages/default/product/shareable-products/shareable-product/shareable-product.module.ts",
		"pages-default-product-shareable-products-shareable-product-shareable-product-module"
	],
	"./pages/default/product/view-product/view-detail-product.module": [
		"./src/app/theme/pages/default/product/view-product/view-detail-product.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"common",
		"pages-default-product-view-product-view-detail-product-module"
	],
	"./pages/default/reports/inventory/inventory.module": [
		"./src/app/theme/pages/default/reports/inventory/inventory.module.ts",
		"common",
		"pages-default-reports-inventory-inventory-module"
	],
	"./pages/default/reports/overview/overview.module": [
		"./src/app/theme/pages/default/reports/overview/overview.module.ts",
		"pages-default-reports-overview-overview-module"
	],
	"./pages/default/reports/sales-by-day/sales-by-day.module": [
		"./src/app/theme/pages/default/reports/sales-by-day/sales-by-day.module.ts",
		"pages-default-reports-sales-by-day-sales-by-day-module"
	],
	"./pages/default/reports/statement/statement.module": [
		"./src/app/theme/pages/default/reports/statement/statement.module.ts",
		"pages-default-reports-statement-statement-module"
	],
	"./pages/default/reports/top-earning/top-earning.module": [
		"./src/app/theme/pages/default/reports/top-earning/top-earning.module.ts",
		"pages-default-reports-top-earning-top-earning-module"
	],
	"./pages/default/reports/top-selling/top-selling.module": [
		"./src/app/theme/pages/default/reports/top-selling/top-selling.module.ts",
		"pages-default-reports-top-selling-top-selling-module"
	],
	"./pages/default/reviews/reviews-list/reviews-list.module": [
		"./src/app/theme/pages/default/reviews/reviews-list/reviews-list.module.ts",
		"pages-default-reviews-reviews-list-reviews-list-module"
	],
	"./pages/default/size/add-size/add-size.module": [
		"./src/app/theme/pages/default/size/add-size/add-size.module.ts",
		"pages-default-size-add-size-add-size-module"
	],
	"./pages/default/size/size-list/size-list.module": [
		"./src/app/theme/pages/default/size/size-list/size-list.module.ts",
		"pages-default-size-size-list-size-list-module"
	],
	"./pages/default/slider/add-slider/add-slider.module": [
		"./src/app/theme/pages/default/slider/add-slider/add-slider.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"common",
		"pages-default-slider-add-slider-add-slider-module"
	],
	"./pages/default/slider/slider-list/slider-list.module": [
		"./src/app/theme/pages/default/slider/slider-list/slider-list.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"common",
		"pages-default-slider-slider-list-slider-list-module"
	],
	"./pages/default/subscription/subscription-add/subscription-add.module": [
		"./src/app/theme/pages/default/subscription/subscription-add/subscription-add.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"common",
		"pages-default-subscription-subscription-add-subscription-add-module"
	],
	"./pages/default/subscription/subscription-list/subscription-list.module": [
		"./src/app/theme/pages/default/subscription/subscription-list/subscription-list.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"common",
		"pages-default-subscription-subscription-list-subscription-list-module"
	],
	"./pages/default/tags/add-tag/add-tag.module": [
		"./src/app/theme/pages/default/tags/add-tag/add-tag.module.ts",
		"pages-default-tags-add-tag-add-tag-module"
	],
	"./pages/default/tags/product-tag/product-tag.module": [
		"./src/app/theme/pages/default/tags/product-tag/product-tag.module.ts",
		"pages-default-tags-product-tag-product-tag-module"
	],
	"./pages/default/tags/tag-list/tag-list.module": [
		"./src/app/theme/pages/default/tags/tag-list/tag-list.module.ts",
		"pages-default-tags-tag-list-tag-list-module"
	],
	"./pages/default/user-group/permission/permission.module": [
		"./src/app/theme/pages/default/user-group/permission/permission.module.ts",
		"pages-default-user-group-permission-permission-module"
	],
	"./pages/default/user-group/user-group.module": [
		"./src/app/theme/pages/default/user-group/user-group.module.ts",
		"pages-default-user-group-user-group-module"
	],
	"./pages/default/vendor/user-add/user-add.module": [
		"./src/app/theme/pages/default/vendor/user-add/user-add.module.ts",
		"pages-default-vendor-user-add-user-add-module"
	],
	"./pages/default/vendor/user-list/user-list.module": [
	...
	"./pages/default/vendor/vendor-list/vendor-list.module": [
		"./src/app/theme/pages/default/vendor/vendor-list/vendor-list.module.ts",
		"pages-default-vendor-vendor-list-vendor-list-module"
	],
	"./pages/default/vendor/vendor-password/vendor-password.module": [
		"./src/app/theme/pages/default/vendor/vendor-password/vendor-password.module.ts",
		"pages-default-vendor-vendor-password-vendor-password-module"
	],
	"./pages/default/withdraw/withdraw-add/withdraw-add.module": [
		"./src/app/theme/pages/default/withdraw/withdraw-add/withdraw-add.module.ts",
		"pages-default-banner-add-banner-add-banner-module~pages-default-banner-banner-list-banner-list-modul~1849ff47",
		"common",
		"pages-default-withdraw-withdraw-add-withdraw-add-module"
	],
	"./pages/default/withdraw/withdraw-list/withdraw-list.module": [
...
var DataService = /** @class */ (function () {
    function DataService() {
        ...
        this.loaderState$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](this.loaderState);
        this.sideBarData = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"]({});
        this.activeMenu = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"]('');
        this.productState = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"]('1');
        this.notification = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](0);
    }
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _amcharts_amcharts3_angular__WEBPACK_IMPORTED_MODULE_10__["AmChartsModule"]
                //MatTabsModule,
            ],
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_1__["Http"], _services_script_loader_service__WEBPACK_IMPORTED_MODULE_3__["ScriptLoaderService"]])
...
/* harmony import */ var _services_reports_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./_services/reports.service */ "./src/app/auth/_services/reports.service.ts");
/* harmony import */ var _services_customer_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./_services/customer.service */ "./src/app/auth/_services/customer.service.ts");
/* harmony import */ var _services_support_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./_services/support.service */ "./src/app/auth/_services/support.service.ts");
/* harmony import */ var _services_menu_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./_services/menu.service */ "./src/app/auth/_services/menu.service.ts");
/* harmony import */ var _services_brand_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./_services/brand.service */ "./src/app/auth/_services/brand.service.ts");
/* harmony import */ var _services_product_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./_services/product.service */ "./src/app/auth/_services/product.service.ts");
/* harmony import */ var _services_category_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./_services/category.service */ "./src/app/auth/_services/category.service.ts");
/* harmony import */ var _services_subCategory_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./_services/subCategory.service */ "./src/app/auth/_services/subCategory.service.ts");
/* harmony import */ var _helpers_index__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./_helpers/index */ "./src/app/auth/_helpers/index.ts");
/* harmony import */ var _services_banner_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./_services/banner.service */ "./src/app/auth/_services/banner.service.ts");
/* harmony import */ var _services_order_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./_services/order.service */ "./src/app/auth/_services/order.service.ts");
/* harmony import */ var _services_reviews_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./_services/reviews.service */ "./src/app/auth/_services/reviews.service.ts");
/* harmony import */ var _services_dropship_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./_services/dropship.service */ "./src/app/auth/_services/dropship.service.ts");
/* harmony import */ var _services_subscription_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./_services/subscription.service */ "./src/app/auth/_services/subscription.service.ts");
/* harmony import */ var _services_withdraw_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./_services/withdraw.service */ "./src/app/auth/_services/withdraw.service.ts");
/* harmony import */ var _services_permission_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./_services/permission.service */ "./src/app/auth/_services/permission.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AuthModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                _services_brand_service__WEBPACK_IMPORTED_MODULE_17__["BrandService"],
                _services_product_service__WEBPACK_IMPORTED_MODULE_18__["ProductService"],
                _services_subscription_service__WEBPACK_IMPORTED_MODULE_26__["SubscriptionService"],
                _services_withdraw_service__WEBPACK_IMPORTED_MODULE_27__["WithdrawService"],
                // api backend simulation
                _helpers_index__WEBPACK_IMPORTED_MODULE_21__["fakeBackendProvider"],
                ...
                _services_reports_service__WEBPACK_IMPORTED_MODULE_13__["ReportsService"],
                _services_customer_service__WEBPACK_IMPORTED_MODULE_14__["CustomerService"],
                _services_reviews_service__WEBPACK_IMPORTED_MODULE_24__["ReviewsService"],
                _services_dropship_service__WEBPACK_IMPORTED_MODULE_25__["DropshipService"],
                _services_support_service__WEBPACK_IMPORTED_MODULE_15__["SupportService"],
                _services_category_service__WEBPACK_IMPORTED_MODULE_19__["CategoryService"],
                _services_menu_service__WEBPACK_IMPORTED_MODULE_16__["MenuService"],
                _services_subCategory_service__WEBPACK_IMPORTED_MODULE_20__["SubCategoryService"],
                _services_banner_service__WEBPACK_IMPORTED_MODULE_22__["BannerService"],
                _services_order_service__WEBPACK_IMPORTED_MODULE_23__["OrderService"],
                _services_permission_service__WEBPACK_IMPORTED_MODULE_28__["PermissionService"]
            ],
...
/***/ "./src/app/theme/layouts/field-error-display/field-error-display.component.html":
/*!**************************************************************************************!*\
  !*** ./src/app/theme/layouts/field-error-display/field-error-display.component.html ***!
  \**************************************************************************************/
/*! no static exports found */
...
var FieldErrorDisplayComponent = /** @class */ (function () {
    ...
    FieldErrorDisplayComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./field-error-display.component.html */ "./src/app/theme/layouts/field-error-display/field-error-display.component.html"),
...
var HeaderNavComponent = /** @class */ (function () {
    ...
    HeaderNavComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], _auth_services_product_service__WEBPACK_IMPORTED_MODULE_1__["ProductService"]])
    ], HeaderNavComponent);
...
/* harmony import */ var _side_bar_side_bar_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./side-bar/side-bar.component */ "./src/app/theme/layouts/side-bar/side-bar.component.ts");
/* harmony import */ var _side_bar_side_bar_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./side-bar/side-bar.service */ "./src/app/theme/layouts/side-bar/side-bar.service.ts");
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var _field_error_display_field_error_display_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./field-error-display/field-error-display.component */ "./src/app/theme/layouts/field-error-display/field-error-display.component.ts");
...
/* harmony import */ var _side_bar_toggle_side_bar_toggle_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./side-bar-toggle/side-bar-toggle.component */ "./src/app/theme/layouts/side-bar-toggle/side-bar-toggle.component.ts");
/* harmony import */ var _pages_default_vendor_vendor_edit_vendor_edit_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../pages/default/vendor/vendor-edit/vendor-edit.component */ "./src/app/theme/pages/default/vendor/vendor-edit/vendor-edit.component.ts");
/* harmony import */ var _pages_default_product_shareable_products_edit_shareable_product_edit_shareable_product_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../pages/default/product/shareable-products/edit-shareable-product/edit-shareable-product.component */ "./src/app/theme/pages/default/product/shareable-products/edit-shareable-product/edit-shareable-product.component.ts");
...
/* harmony import */ var ng2_select__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ng2-select */ "./node_modules/ng2-select/index.js");
/* harmony import */ var ng2_select__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(ng2_select__WEBPACK_IMPORTED_MODULE_24__);
/* harmony import */ var _pages_default_color_add_color_add_color_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../pages/default/color/add-color/add-color.component */ "./src/app/theme/pages/default/color/add-color/add-color.component.ts");
/* harmony import */ var _pages_default_color_color_list_color_list_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../pages/default/color/color-list/color-list.component */ "./src/app/theme/pages/default/color/color-list/color-list.component.ts");
/* harmony import */ var _pages_default_size_add_size_add_size_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../pages/default/size/add-size/add-size.component */ "./src/app/theme/pages/default/size/add-size/add-size.component.ts");
/* harmony import */ var _pages_default_tags_add_tag_add_tag_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../pages/default/tags/add-tag/add-tag.component */ "./src/app/theme/pages/default/tags/add-tag/add-tag.component.ts");
/* harmony import */ var _pages_default_size_size_list_size_list_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../pages/default/size/size-list/size-list.component */ "./src/app/theme/pages/default/size/size-list/size-list.component.ts");
/* harmony import */ var _pages_default_tags_tag_list_tag_list_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../pages/default/tags/tag-list/tag-list.component */ "./src/app/theme/pages/default/tags/tag-list/tag-list.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    LayoutModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _field_error_display_field_error_display_component__WEBPACK_IMPORTED_MODULE_18__["FieldErrorDisplayComponent"],
                _side_bar_toggle_side_bar_toggle_component__WEBPACK_IMPORTED_MODULE_20__["SideBarToggleComponent"],
                _pages_default_vendor_vendor_edit_vendor_edit_component__WEBPACK_IMPORTED_MODULE_21__["VendorEditComponent"],
                _pages_default_product_shareable_products_edit_shareable_product_edit_shareable_product_component__WEBPACK_IMPORTED_MODULE_22__["EditShareableProductComponent"],
                _pages_default_color_add_color_add_color_component__WEBPACK_IMPORTED_MODULE_25__["AddColorComponent"], _pages_default_size_add_size_add_size_component__WEBPACK_IMPORTED_MODULE_27__["AddSizeComponent"], _pages_default_tags_add_tag_add_tag_component__WEBPACK_IMPORTED_MODULE_28__["AddTagComponent"],
                _pages_default_color_color_list_color_list_component__WEBPACK_IMPORTED_MODULE_26__["ColorListComponent"], _pages_default_size_size_list_size_list_component__WEBPACK_IMPORTED_MODULE_29__["SizeListComponent"], _pages_default_tags_tag_list_tag_list_component__WEBPACK_IMPORTED_MODULE_30__["TagListComponent"]
            ],
            exports: [
                _layout_layout_component__WEBPACK_IMPORTED_MODULE_1__["LayoutComponent"],
                _pages_aside_left_minimize_default_enabled_aside_left_minimize_default_enabled_component__WEBPACK_IMPORTED_MODULE_2__["AsideLeftMinimizeDefaultEnabledComponent"],
            ...
            imports: [
                ...
                primeng_primeng__WEBPACK_IMPORTED_MODULE_19__["FileUploadModule"],
                ngx_pagination__WEBPACK_IMPORTED_MODULE_23__["NgxPaginationModule"],
                ng2_select__WEBPACK_IMPORTED_MODULE_24__["SelectModule"],
            ],
            providers: [_side_bar_side_bar_service__WEBPACK_IMPORTED_MODULE_15__["SideBarService"], _services_data_service__WEBPACK_IMPORTED_MODULE_16__["DataService"]],
        })
    ], LayoutModule);
    return LayoutModule;
}());
...
/***/ "./src/app/theme/layouts/side-bar-toggle/side-bar-toggle.component.html":
/*!******************************************************************************!*\
  !*** ./src/app/theme/layouts/side-bar-toggle/side-bar-toggle.component.html ***!
  \******************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var _side_bar_side_bar_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../side-bar/side-bar.service */ "./src/app/theme/layouts/side-bar/side-bar.service.ts");
/* harmony import */ var _side_bar_side_bar_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../side-bar/side-bar.component */ "./src/app/theme/layouts/side-bar/side-bar.component.ts");
...
var SideBarToggleComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _side_bar_side_bar_component__WEBPACK_IMPORTED_MODULE_2__["SideBarComponent"])
    ...
    SideBarToggleComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./side-bar-toggle.component.html */ "./src/app/theme/layouts/side-bar-toggle/side-bar-toggle.component.html"),
        ...
        __metadata("design:paramtypes", [_side_bar_side_bar_service__WEBPACK_IMPORTED_MODULE_1__["SideBarService"],
...
/***/ "./src/app/theme/layouts/side-bar/side-bar.component.html":
/*!****************************************************************!*\
  !*** ./src/app/theme/layouts/side-bar/side-bar.component.html ***!
  \****************************************************************/
/*! no static exports found */
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var _side_bar_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./side-bar.service */ "./src/app/theme/layouts/side-bar/side-bar.service.ts");
/* harmony import */ var _services_data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../_services/data.service */ "./src/app/_services/data.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var SideBarComponent = /** @class */ (function () {
    ...
    SideBarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./side-bar.component.html */ "./src/app/theme/layouts/side-bar/side-bar.component.html"),
...
/***/ "./src/app/theme/pages/default/product/shareable-products/edit-shareable-product/edit-shareable-product.component.html":
/*!*****************************************************************************************************************************!*\
  !*** ./src/app/theme/pages/default/product/shareable-products/edit-shareable-product/edit-shareable-product.component.html ***!
  \*****************************************************************************************************************************/
/*! no static exports found */
...
var EditShareableProductComponent = /** @class */ (function () {
    ...
    EditShareableProductComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'edit-shareable-product',
            template: __webpack_require__(/*! ./edit-shareable-product.component.html */ "./src/app/theme/pages/default/product/shareable-products/edit-shareable-product/edit-shareable-product.component.html"),
        }),
        __metadata("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"], _auth_services_product_service__WEBPACK_IMPORTED_MODULE_2__["ProductService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
...
/***/ "./src/app/theme/pages/default/tags/tag-list/tag-list.component.html":
/*!***************************************************************************!*\
  !*** ./src/app/theme/pages/default/tags/tag-list/tag-list.component.html ***!
  \***************************************************************************/
/*! no static exports found */
...
var TagListComponent = /** @class */ (function () {
    ...
    TagListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./tag-list.component.html */ "./src/app/theme/pages/default/tags/tag-list/tag-list.component.html"),
            styles: []
        }),
        __metadata("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], _auth_services_product_service__WEBPACK_IMPORTED_MODULE_1__["ProductService"]])
    ], TagListComponent);
...
/***/ "./src/app/theme/pages/default/vendor/vendor-edit/vendor-edit.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/theme/pages/default/vendor/vendor-edit/vendor-edit.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
var VendorEditComponent = /** @class */ (function () {
    ...
    VendorEditComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./vendor-edit.component.html */ "./src/app/theme/pages/default/vendor/vendor-edit/vendor-edit.component.html"),
        }),
        __metadata("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"], _auth_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]])
    ], VendorEditComponent);
...
var routes = [
    {
        ...
        "children": [
            ...
            },
            {
                ...
                "loadChildren": ".\/pages\/default\/vendor\/vendor-list\/vendor-list.module#VendorListModule"
            },
            {
                "path": "user\/user-list",
                "loadChildren": ".\/pages\/default\/vendor\/user-list\/user-list.module#UserListModule"
            },
            {
                "path": "user\/user-add",
                "loadChildren": ".\/pages\/default\/vendor\/user-add\/user-add.module#UserAddModule"
            },
            {
                "path": "vendor\/vendor-detail\/:id",
                "loadChildren": ".\/pages\/default\/vendor\/vendor-detail\/vendor-detail.module#VendorDetailModule"
            },
            {
                "path": "vendor\/vendor-password\/:id",
                "loadChildren": ".\/pages\/default\/vendor\/vendor-password\/vendor-password.module#VendorPasswordModule"
            },
            {
                "path": "subscription\/subscription-list",
                "loadChildren": ".\/pages\/default\/subscription\/subscription-list\/subscription-list.module#SubscriptionListModule"
            },
            {
                "path": "withdraw\/withdraw-list",
                "loadChildren": ".\/pages\/default\/withdraw\/withdraw-list\/withdraw-list.module#WithdrawListModule"
            },
            {
                "path": "withdraw\/withdraw-add",
                "loadChildren": ".\/pages\/default\/withdraw\/withdraw-add\/withdraw-add.module#WithdrawAddModule"
            },
            {
                "path": "subscription\/subscription-add",
                "loadChildren": ".\/pages\/default\/subscription\/subscription-add\/subscription-add.module#SubscriptionAddModule"
            },
            {
                "path": "reports\/overview",
                "loadChildren": ".\/pages\/default\/reports\/overview\/overview.module#OverviewModule"
            },
            {
                "path": "reports\/inventory",
                "loadChildren": ".\/pages\/default\/reports\/inventory\/inventory.module#InventoryModule"
            },
            {
                "path": "reports\/sales-by-day",
                "loadChildren": ".\/pages\/default\/reports\/sales-by-day\/sales-by-day.module#SalesByDayModule"
            },
            {
                "path": "reports\/top-earning",
                "loadChildren": ".\/pages\/default\/reports\/top-earning\/top-earning.module#TopEarningModule"
            },
            {
                "path": "reports\/top-selling",
                "loadChildren": ".\/pages\/default\/reports\/top-selling\/top-selling.module#TopSellingModule"
            },
            {
                "path": "reports\/statement",
                "loadChildren": ".\/pages\/default\/reports\/statement\/statement.module#StatementModule"
            },
            {
                "path": "customer\/customer-list",
                "loadChildren": ".\/pages\/default\/customer\/customer-list\/customer-list.module#CustomerListModule"
            },
            {
                "path": "dropship",
                "loadChildren": ".\/pages\/default\/dropship\/dropship.module#DropshipModule"
            },
            {
                "path": "user-group",
                "loadChildren": ".\/pages\/default\/user-group\/user-group.module#UserGroupModule"
            },
            {
                "path": "drag-drop",
                "loadChildren": ".\/pages\/default\/drag-drop\/drag-drop.module#DragDropModule"
            },
            {
                "path": "user-group\/permission\/:id",
                "loadChildren": ".\/pages\/default\/user-group\/permission\/permission.module#PermissionModule"
            },
            {
                "path": "dropship\/dropship-list",
                "loadChildren": ".\/pages\/default\/dropship\/dropship-list\/dropship-list.module#DropshipListModule"
            },
            {
                "path": "dropship\/:id",
                "loadChildren": ".\/pages\/default\/dropship\/dropship-view\/dropship-view.module#DropshipViewModule"
            },
            {
                "path": "reviews\/reviews-list",
                "loadChildren": ".\/pages\/default\/reviews\/reviews-list\/reviews-list.module#ReviewsListModule"
            },
            {
                "path": "customer\/support-list",
                "loadChildren": ".\/pages\/default\/customer\/support-list\/support-list.module#SupportListModule"
            },
            {
                "path": "customer\/staff-list",
                "loadChildren": ".\/pages\/default\/customer\/staff-list\/staff-list.module#StaffListModule"
            },
            {
                "path": "customer\/staff-list\/staff-permission\/:id",
                "loadChildren": ".\/pages\/default\/customer\/staff-list\/staff-permission\/staff-permission.module#StaffPermissionModule"
            },
            {
                "path": "customer\/support-details\/:id",
                "loadChildren": ".\/pages\/default\/customer\/support-details\/support-details.module#SupportDetailsModule"
            },
            {
                "path": "category\/menu-list",
                "loadChildren": ".\/pages\/default\/category\/menu-list\/menu-list.module#MenuListModule"
            },
            {
                "path": "category\/menu-edit\/:menu_id",
                "loadChildren": ".\/pages\/default\/category\/menu-edit\/menu-edit.module#MenuEditModule"
            },
            {
                "path": "category\/category-list",
                "loadChildren": ".\/pages\/default\/category\/category-list\/category-list.module#CategoryListModule"
            },
            {
                "path": "category\/category-edit\/:category_id",
                "loadChildren": ".\/pages\/default\/category\/category-edit\/category-edit.module#CategoryEditModule"
            },
            {
                "path": "category\/sub-category-list",
                "loadChildren": ".\/pages\/default\/category\/sub-category-list\/sub-category-list.module#SubCatgoryListModule"
            },
            {
                "path": "sub-category\/edit-sub-category\/:sub_cat_id",
                "loadChildren": ".\/pages\/default\/category\/edit-sub-category\/edit-sub-category.module#EditSubCategoryModule"
            },
            {
                "path": "brand\/brand-list",
                "loadChildren": ".\/pages\/default\/brand\/brand-list\/brand-list.module#BrandListModule"
            },
            {
                "path": "brand\/brand-edit\/:brand_id",
                "loadChildren": ".\/pages\/default\/brand\/brand-edit\/brand-edit.module#BrandEditModule"
            },
            {
                "path": "product\/add-product\/:id",
                "loadChildren": ".\/pages\/default\/product\/add-product\/add-product.module#AddProductModule"
            },
            {
            ...
            },
            {
                ...
                "loadChildren": ".\/pages\/default\/product\/bulk-upload\/bulk-upload.module#BulkUploadModule"
            },
            {
                "path": "product\/child-view",
                "loadChildren": ".\/pages\/default\/product\/child-view\/child-view.module#ChildViewModule"
            },
            {
                "path": "product\/edit-product\/:product_id",
                "loadChildren": ".\/pages\/default\/product\/edit-product\/edit-product.module#EditProductModule"
            },
            {
                "path": "product\/view-product\/:product_id",
                "loadChildren": ".\/pages\/default\/product\/view-product\/view-detail-product.module#ViewDetailProductModule"
            },
            {
                "path": "product\/shareable-product-detail\/:id",
                "loadChildren": ".\/pages\/default\/product\/shareable-products\/shareable-product-detail\/shareable-product-detail.module#ShareableProductDetailModule"
            },
            {
                "path": "product\/shareable-product",
                "loadChildren": ".\/pages\/default\/product\/shareable-products\/shareable-product\/shareable-product.module#ShareableProductModule"
            },
            {
            ...
            {
                "path": "size\/add-size",
                "loadChildren": ".\/pages\/default\/size\/add-size\/add-size.module#AddSizeModule"
            },
            {
                "path": "size",
                "loadChildren": ".\/pages\/default\/size\/size-list\/size-list.module#SizeListModule"
            },
            {
                "path": "color\/add-color",
                "loadChildren": ".\/pages\/default\/color\/add-color\/add-color.module#AddColorModule"
            },
            {
                "path": "color",
                "loadChildren": ".\/pages\/default\/color\/color-list\/color-list.module#ColorListModule"
            },
            {
                "path": "tag\/add-tag",
                "loadChildren": ".\/pages\/default\/tags\/add-tag\/add-tag.module#AddTagModule"
            },
            {
                "path": "tag",
                "loadChildren": ".\/pages\/default\/tags\/tag-list\/tag-list.module#TagListModule"
            },
            {
                "path": "product-tag",
                "loadChildren": ".\/pages\/default\/tags\/product-tag\/product-tag.module#ProductTagModule"
            },
            {
                "path": "discount\/discount-offer",
                "loadChildren": ".\/pages\/default\/discount\/add-discount.module#AddDiscountModule"
            },
            {
                "path": "banner\/add-banner",
                "loadChildren": ".\/pages\/default\/banner\/add-banner\/add-banner.module#AddBannerModule"
            },
            {
                "path": "banner\/banner-list",
                "loadChildren": ".\/pages\/default\/banner\/banner-list\/banner-list.module#BannerListModule"
            },
            {
                "path": "slider\/add-slider",
                "loadChildren": ".\/pages\/default\/slider\/add-slider\/add-slider.module#AddSliderModule"
            },
            {
                "path": "slider\/slider-list",
                "loadChildren": ".\/pages\/default\/slider\/slider-list\/slider-list.module#SliderListModule"
            },
            {
                "path": "order\/order-list",
                "loadChildren": ".\/pages\/default\/order\/order-list\/order-list.module#OrderListModule"
            },
            {
            ...
            // },
            {
                ...
                "loadChildren": ".\/pages\/default\/order\/order-edit\/order-edit.module#OrderEditModule"
            },
            {
                "path": "order\/order-summary\/:order_no",
                "loadChildren": ".\/pages\/default\/order\/order-summary\/order-summary.module#OrderSummaryModule"
            },
            /* {
             ...
             },*/
            {
                ...
                "loadChildren": ".\/pages\/default\/attribute\/add-attribute\/add-attribute.module#AddAttributeModule"
            },
            {
                "path": "attributes",
                "loadChildren": ".\/pages\/default\/attribute\/attribute-list\/attribute-list.module#AttributeListModule"
            },
            {
                "path": "attribute/attribute-value/:att_id",
                "loadChildren": ".\/pages\/default\/attribute\/attribute-value\/attribute-value.module#AttributeValueModule"
            },
            {
                "path": "index",
