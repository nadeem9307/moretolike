...
/***/ "./src/app/theme/pages/default/banner/add-banner/add-banner.component.html":
/*!*********************************************************************************!*\
  !*** ./src/app/theme/pages/default/banner/add-banner/add-banner.component.html ***!
  \*********************************************************************************/
...
var AddBannerComponent = /** @class */ (function () {
    /* public menuDrpdown = "";
     ...
     public productType = "";*/
    function AddBannerComponent(toastr, router, _bannerService, _menuService, formBuilder) {
        this.toastr = toastr;
        this.router = router;
    ...
    AddBannerComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.formBuilder.group({
            banner_title: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            sub_title: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            redirect_url: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            status: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            banner_type: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]
        });
    };
    AddBannerComponent.prototype.isFieldValid = function (field) {
        return ((!this.form.get(field).valid && this.form.get(field).touched) ||
            (this.form.get(field).untouched && this.formSumitAttempt));
    };
    AddBannerComponent.prototype.displayFieldCss = function (field) {
        return {
            'has-error': this.isFieldValid(field),
            'has-feedback': this.isFieldValid(field)
        };
    };
    AddBannerComponent.prototype.onSubmit = function () {
        var _this = this;
        var input;
        ...
        if (this.form.valid) {
            ...
            console.log(input);
            this._bannerService.createBanner(input).subscribe(function (data) {
                // this.subCategoryData = data.success;
                _this.menuDrpdown = data.menu;
                _this.toastr.success('Banner Added Successfully', 'Success Message');
                _this.reset();
            });
        }
    };
    AddBannerComponent.prototype.reset = function () {
    ...
    AddBannerComponent.prototype.handleFileInput = function (files) {
        var _this = this;
        var file = files.item(0);
        var reader = new FileReader();
        reader.onload = function (event) {
            _this.bannerImgUrl = event.target.result;
        };
        reader.readAsDataURL(file);
    };
    AddBannerComponent.prototype.onItemSelect = function (item) {
        // this.selectedItems.push(item);
        console.log(this.selectedItems);
    };
    AddBannerComponent.prototype.onSelectAll = function (items) {
        console.log(items);
    };
    AddBannerComponent.prototype.onDeSelectItem = function (item) {
        console.log(this.selectedItems);
    };
    AddBannerComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-add-banner',
            template: __webpack_require__(/*! ./add-banner.component.html */ "./src/app/theme/pages/default/banner/add-banner/add-banner.component.html"),
            styles: []
        }),
...
/* harmony import */ var _add_banner_add_banner_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../add-banner/add-banner.component */ "./src/app/theme/pages/default/banner/add-banner/add-banner.component.ts");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: _add_banner_add_banner_component__WEBPACK_IMPORTED_MODULE_2__["AddBannerComponent"]
            }
        ]
    },
];
var AddBannerModule = /** @class */ (function () {
    function AddBannerModule() {
    }
    AddBannerModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_add_banner_add_banner_component__WEBPACK_IMPORTED_MODULE_2__["AddBannerComponent"]]
        })
    ], AddBannerModule);
...
//# sourceMappingURL=pages-default-banner-add-banner-add-banner-module.js.map