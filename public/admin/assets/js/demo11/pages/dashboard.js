    ...
    return {
        init: function () {
            ...
            function () {
                ...
                /****Diff 1**/
                  if (KTUtil.getByID("kt_chart_profit_share_1")) {
                    var t = {
                            type: "doughnut",
                            data: {
                                datasets: [{
                        ...
                        e = KTUtil.getByID("kt_chart_profit_share_1").getContext("2d");
                    new Chart(e, t)
                }
                  ...
                  if (KTUtil.getByID("kt_chart_profit_share_2")) {
                    var t = {
                        ...
                        e = KTUtil.getByID("kt_chart_profit_share_2").getContext("2d");
                    new Chart(e, t)
                }
                
                  /****Diff 1**/
                  if (KTUtil.getByID("kt_chart_profit_share_3")) {
                    var t = {
                            type: "doughnut",
                            data: {
                                datasets: [{
                        ...
                        e = KTUtil.getByID("kt_chart_profit_share_3").getContext("2d");
                    new Chart(e, t)
                }
            ...
            function () {
                ...
                }(), t($(".kt_chart_quick_stats_1"), [10, 14, 18, 11, 9, 12, 14, 17, 18, 14], KTApp.getStateColor("brand"), 3), t($(".kt_chart_quick_stats_2"), [11, 12, 18, 13, 11, 12, 15, 13, 19, 15], KTApp.getStateColor("danger"), 3),
                
                t($(".kt_chart_quick_stats_3"), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], KTApp.getStateColor("success"), 3), t($(".kt_chart_quick_stats_4"), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], KTApp.getStateColor("success"), 3),
                t($(".kt_chart_quick_stats_5"), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], KTApp.getStateColor("danger"), 3), t($(".kt_chart_quick_stats_6"), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], KTApp.getStateColor("brand"), 3),
                function () {
                 ...
                 t($(".admin_sec_chart_1"), [10, 14, 18, 11, 9, 12, 14, 17, 18, 14], KTApp.getStateColor("brand"), 3), t($(".kt_chart_quick_stats_2"), [11, 12, 18, 13, 11, 12, 15, 13, 19, 15], KTApp.getStateColor("danger"), 3), t($(".kt_chart_quick_stats_3"), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], KTApp.getStateColor("success"), 3), t($(".kt_chart_quick_stats_4"), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], KTApp.getStateColor("success"), 3),
                t($(".kt_chart_quick_stats_5"), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], KTApp.getStateColor("danger"), 3), t($(".kt_chart_quick_stats_6"), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], KTApp.getStateColor("brand"), 3),
                function () {
                    var t = KTUtil.getByID("kt_chart_order_statistics");
                    if (t) {
     ...
     /*********CUSTOME***********/           
                ...
                t($(".admin_sec_chart_2"), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], KTApp.getStateColor("danger"), 3), t($(".admin_sec_chart_2"), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], KTApp.getStateColor("brand"), 3),
                function () {
                    var t = KTUtil.getByClass("kt_chart_order_statistics");
                    if (t) {
                        var e = Chart.helpers.color,
                            a = {
                                labels: ["1 Jan", "2 Jan", "3 Jan", "4 Jan", "5 Jan", "6 Jan", "7 Jan"],
                ...
                t($(".admin_sec_chart_3"), [12, 12, 18, 11, 15, 12, 13, 16, 11, 18], KTApp.getStateColor("danger"), 3), t($(".admin_sec_chart_3"), [11, 9, 13, 18, 13, 15, 14, 13, 18, 15], KTApp.getStateColor("brand"), 3),
                function () {
                    var t = KTUtil.getByID("kt_chart_order_statistics");
                    if (t) {
                        var e = Chart.helpers.color,
