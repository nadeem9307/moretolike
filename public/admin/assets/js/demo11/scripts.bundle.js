...
var KTLayout = function () {
    var t, e, a, n, i, o = function () {
        return new KTPortlet("kt_page_portlet", {
            sticky: {
                ...
                position: {
                    top: function () {
                        return KTUtil.isInResponsiveRange("desktop") ? parseInt(KTUtil.actualHeight(KTUtil.get("kt_header"), "height")) : parseInt(KTUtil.css(KTUtil.get("kt_header_mobile"), "height"))
                    },
                    left: function (t) {
                        var e = t.getSelf();
    ...
    return {
        ...
        initAside: function () {
            var e, i, o, l, r, s, d;
            o = KTUtil.get("kt_aside"), KTUtil.get("kt_aside_brand"), l = KTUtil.hasClass(o, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside", n = new KTOffcanvas("kt_aside", {
                baseClass: l,
                overlay: !0,
            ...
            }), KTUtil.hasClass(t, "kt-aside--fixed") && (KTUtil.addEvent(o, "mouseenter", function (n) {
                n.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (i && (clearTimeout(i), i = null), e = setTimeout(function () {
                    ...
                    }), KTUtil.addClass(t, "kt-aside--minimize-hover"), a.scrollUpdate(), a.scrollTop())
                }, 50))
            }), KTUtil.addEvent(o, "mouseleave", function (n) {
                n.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (e && (clearTimeout(e), e = null), i = setTimeout(function () {
                    KTUtil.hasClass(t, "kt-aside--minimize-hover") && KTUtil.isInResponsiveRange("desktop") && (KTUtil.removeClass(t, "kt-aside--minimize-hover"), KTUtil.addClass(t, "kt-aside--minimize"), KTUtil.addClass(t, "kt-aside--minimizing"), KTUtil.transitionEnd(t, function () {
                        KTUtil.removeClass(t, "kt-aside--minimizing")
                    }), a.scrollUpdate(), a.scrollTop())
                }, 100))
            })), s = KTUtil.get("kt_aside_menu"), d = "1" === KTUtil.attr(s, "data-ktmenu-dropdown") ? "dropdown" : "accordion", "1" === KTUtil.attr(s, "data-ktmenu-scroll") && (r = {
                rememberPosition: !0,
                height: function () {
                    return KTUtil.isInResponsiveRange("desktop") ? parseInt(KTUtil.getViewPort().height) - parseInt(KTUtil.actualHeight("kt_header", !1)) - parseInt(KTUtil.actualHeight("kt_footer", !1)) - parseInt(KTUtil.css(s, "marginTop")) - parseInt(KTUtil.css(s, "marginBottom")) : parseInt(KTUtil.getViewPort().height)
                }
            ...
            , s = KTUtil.get("kt_aside_menu1"), d = "1" === KTUtil.attr(s, "data-ktmenu-dropdown") ? "dropdown" : "accordion", "1" === KTUtil.attr(s, "data-ktmenu-scroll") && (r = {
                rememberPosition: !0,
                height: function () {
                    return KTUtil.isInResponsiveRange("desktop") ? parseInt(KTUtil.getViewPort().height) - parseInt(KTUtil.actualHeight("kt_header", !1)) - parseInt(KTUtil.actualHeight("kt_footer", !1)) - parseInt(KTUtil.css(s, "marginTop")) - parseInt(KTUtil.css(s, "marginBottom")) : parseInt(KTUtil.getViewPort().height)
                }
            }), a = new KTMenu("kt_aside_menu1", {
                scroll: r,
                submenu: {
                    desktop: d,
                    tablet: "accordion",
