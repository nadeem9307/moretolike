...
<!--     <link rel="stylesheet" href="/resources/demos/style.css">-->    
    ...
    overflow-y: scroll;
    overflow-x: hidden;}
    #categaries_001::-webkit-scrollbar-track
    {
      -webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);
      background-color: #F5F5F5;
    }

    #categaries_001::-webkit-scrollbar
    {
      width: 10px;
      background-color: #F5F5F5;
    }

    #categaries_001::-webkit-scrollbar-thumb
    {
      background-color: #000000;
      border: 2px solid #555555;
    }
  ul#brand_mob_menu{height: 200px;
    overflow-y: scroll;
    overflow-x: hidden;}
     #brand_mob_menu::-webkit-scrollbar-track
    {
      -webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);
      background-color: #F5F5F5;
    }

    #brand_mob_menu::-webkit-scrollbar
    {
      width: 10px;
      background-color: #F5F5F5;
    }

    #brand_mob_menu::-webkit-scrollbar-thumb
    {
      background-color: #000000;
      border: 2px solid #555555;
    }
    ul#retailers1{height: 200px;
    overflow-y: scroll;
    overflow-x: hidden;}
     #retailers1::-webkit-scrollbar-track
    {
      -webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);
      background-color: #F5F5F5;
    }

    #retailers1::-webkit-scrollbar
    {
      width: 10px;
      background-color: #F5F5F5;
    }

    #retailers1::-webkit-scrollbar-thumb
    {
      background-color: #000000;
      border: 2px solid #555555;
    }
...
.nav-bar-1 ul li:nth-child(3){
  background: #fed700;
}

.nav-bar-1 ul li:hover:not(.active){
 /* background: #D80B15;*/
}
...
.search-box-1:before{
  ...
  border-bottom: 14px solid #fed700;
}
...
.search-box-1 input[type="button"]{
  width: 80px;
  padding: 5px 0;
  background: #fed700;
  color: #fff;
  ...
  .leftmenuposition{position: absolute;left: 20px;top: 70px;}
  .logoposition{padding-left: 115px;}
  ...
  @media (max-width: 1199px) and (min-width: 992px){
    ul.dropdown-menu.right{position: relative; right:65px;}
  }
    </style>
...
<div class="nav-side-menu wdth">
    ...
    <div class="row" style="border-bottom: 1px solid #d6d6d6; padding: 5px;"> 
        <div class="col-xs-12">
            ...
            {{csrf_field()}}
              <input name='product_cat' id='product_sub_cat' type="hidden">
            ...
            <ul id="menu-content" class="menu-content">
              ...
              <aside class="widget woocommerce widget_product_categories electro_widget_product_categories">
                            <ul class="product-categories category-single">
                                <li class="product_cat">
                                 <ul>
                                   <li class="cat-item current-cat"><a href=""><span class="child-indicator open"><i class="fa fa-angle-up"></i></span>Browse Categaries</a> <span class="count">(13)</span>
                                            <ul class="children readmore" style="display: block;">
                        ...
                        <aside class="widget widget_electro_products_filter">
                            ...
                            <aside class="widget woocommerce widget_layered_nav">
                                ...
                                <ul>
                                    <li><input type="checkbox" > <span class="inputpa">Apple </span><span class="count">(4)</span></li>
                                    <li><input type="checkbox" > <span class="inputpa">Gionee </span><span class="count">(2)</span></li>
                                    <li><input type="checkbox" > <span class="inputpa">HTC </span><span class="count">(2)</span></li>
                                    <li><input type="checkbox" > <span class="inputpa">LG </span><span class="count">(2)</span></li>
                                    <li><input type="checkbox" > <span class="inputpa">Micromax</span><span class="count">(1)</span></li>
                                </ul>
                  ...
                  <ul >
                  <li><aside class="widget widget_text">
                                ...
                                <nav>
                                    <ul id="menu-main-menu" class="nav nav-inline yamm">
                                       ...
                                       <li class="menu-item animate-dropdown">
                                        ...
                                        <li class="menu-item menu-item-has-children animate-dropdown dropdown ham-menu-left"><a title="Menu" href="">Menu</a>
                                        ...
                                        <li class="menu-item animate-dropdown"><a title="Explore" href="#">Explore</a></li>
                                         <li class="menu-item animate-dropdown"><a title="Shop" href="#">Shop</a></li>
                                          <li class="menu-item animate-dropdown"><a title="People" href="#">People</a></li>
                                           <li class="menu-item animate-dropdown"><a title="Store" href="#">Stores</a></li>
...
<div class="col-sm-2">
  <ul class="navbar-mini-cart navbar-nav animate-dropdown nav flip cart_anchor" id="cart_content">
                                          <li class="nav-item dropdown "> <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"> <i class="ec ec-shopping-bag"></i> 
                                          @if($getTotlaQty > 0)
                                          ...
                                          @endif
                                           <span class="cart-items-total-price total-price"><span class="amount amount_total">&#36;{{$getSubTotal}}</span></span> </a>
                                            <ul class="dropdown-menu dropdown-menu-mini-cart scrollbar addscroll">
                                              <li>
                                                <div class="widget_shopping_cart_content" >
                                                  <ul class="cart_list product_list_widget " style="height: 200px;overflow-y: auto;">
                                                    @foreach($cart as $key=> $cart_item)
                                                    <li class="mini_cart_item" > <a title="Remove this item" class="remove" href="javascript:void(0)" onclick="removeCart({{$cart_item->id}},{{$cart_item->quantity}},{{$cart_item->price}},{{$getTotlaQty}},{{$getSubTotal}})" id="{{$cart_item->id}}">×</a> <a href="javascript:void(0)"> <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="{{getenv('URL')}}{{$cart_item->attributes['img']}}" alt="">{{$cart_item->name}}&nbsp; </a> <span class="quantity">{{$cart_item->quantity}} × <span class="amount amount_total">{{$cart_item->price}}</span></span> </li>
                                                    @endforeach
                                                  </ul>
                                                  <!-- end product list -->
...
<!-- <div class="top-bar1 hidden-lg-up">
    <div class="row">
        <div class="col-sm-5 col-xs-5 rightrt"><a title="Shop" href="/shop-list" style="color: #333e48;">
            <i class="fa fa-bell">  <span class="value2">0</span></i>&nbsp; &nbsp; Notification</a></div>
         <div class="col-sm-5 col-xs-7 centert"><a title="Shop" id="login" href="#" data-toggle="modal" data-target="#myModal" style="color: #333e48;"><i class="ec ec-shopping-bag"></i>Register Or Sign in</a></div>
    </div>
