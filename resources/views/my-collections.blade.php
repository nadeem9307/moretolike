...
<nav class="woocommerce-breadcrumb" ><a href="/">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span><a href="javascript:void(0)">My Collections</a></nav>
...
<header class="page-header">
    ...
    <h1 class="page-title text-uppercase" style="">My Collections 
    </h1>
                    ...
                    <div class="product-outer">
                        <div class="product-inner">
                            <span class="loop-product-categories">
                                <a href="/product-details/{{$store_product_list1->slug}}" rel="tag">{{$store_product_list1->category == '' ? $store_product_list1->name : $store_product_list1->category}}</a>
