...
let UserGroupComponent = class UserGroupComponent {
    constructor(imgBaseUrl, toastr, _categoryService, _permissionService) {
    ...
    ngOnInit() {
        this._permissionService.getAllUserGroup().subscribe(data => {
            this.userGroupData = data.success;
        });
    }
};
...
//# sourceMappingURL=pages-default-user-group-user-group-module-es2015.js.map