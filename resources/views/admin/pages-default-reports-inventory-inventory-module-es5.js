...
var InventoryComponent = /** @class */ (function () {
    function InventoryComponent(router, toastr, _reportsService, route, _brandService, _menuService, _categoryService, _productService, _subCategory, _dataService, _script) {
        this.router = router;
        this.toastr = toastr;
    ...
    InventoryComponent.prototype.search = function () {
        var _this = this;
    ...
    InventoryComponent.prototype.customer_delete = function (del_id) {
        var _this = this;
        console.log(del_id);
    ...
    InventoryComponent.prototype.changeDate = function (changeDate) {
        var _this = this;
        this.currentUser = JSON.parse(localStorage.getItem('currentUser'));
        var user_id = this.currentUser.success.id;
        var user_role = this.currentUser.success.role;
        var end_date = changeDate.endDate.toDate();
        var start_date = changeDate.startDate.toDate();
        this._reportsService.productByDateRange({ start_date: start_date, end_date: end_date, role: user_role, loggedUserId: user_id }).subscribe(function (data) {
            _this.productData = data.success;
        });
    };
    InventoryComponent.prototype.changeStatus = function (customer) {
    ...
    InventoryComponent.prototype.sortReport = function () {
        console.log('you have going right');
    };
    InventoryComponent.prototype.exportCSV = function (productData) {
        var ReportTitle = 'Product Inventory Report';
        var ShowLabel = true;
        /*export csv*/
...
/* harmony import */ var ngx_daterangepicker_material__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ngx-daterangepicker-material */ "./node_modules/ngx-daterangepicker-material/esm5/ngx-daterangepicker-material.js");
...
//# sourceMappingURL=pages-default-reports-inventory-inventory-module-es5.js.map