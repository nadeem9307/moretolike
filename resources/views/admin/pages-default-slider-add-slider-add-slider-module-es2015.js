...
let AddSliderComponent = class AddSliderComponent {
    ...
    ngOnInit() {
        ...
        this._bannerService.getProduct().subscribe(data => {
    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            ...
            console.log(input);*/
            this._bannerService.createSlider(input).subscribe(data => {
                // this.subCategoryData = data.success;
                this.menuDrpdown = data.menu;
                this.toastr.success('slider Added Successfully', 'Success Message');
                this.reset();
            });
        }
    }
...
let AddSliderModule = class AddSliderModule {
};
...
//# sourceMappingURL=pages-default-slider-add-slider-add-slider-module-es2015.js.map