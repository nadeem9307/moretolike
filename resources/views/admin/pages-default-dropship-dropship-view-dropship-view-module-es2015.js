...
/***/ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/dropship/dropship-view/dropship-view.component.html":
/*!*******************************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/theme/pages/default/dropship/dropship-view/dropship-view.component.html ***!
  \*******************************************************************************************************************/
...
let DropshipViewComponent = class DropshipViewComponent {
    constructor(imgBaseUrl, toastr, _dropshipService, router, route) {
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            this.dropship_id = params.id;
            this._dropshipService.getById(params.id).subscribe(data => {
                // console.log(data);
                this.dropshipData = data.success;
            });
        });
    }
    productDelete(del_id) {
        ...
        if (value) {
            this._dropshipService.del_dropship_product({ product_id: del_id, dropship_id: this.dropship_id }).subscribe(data => {
                console.log(data);
                this.dropshipData = data.data;
            });
        }
    }
};
DropshipViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dropship-view',
        template: __webpack_require__(/*! raw-loader!./dropship-view.component.html */ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/dropship/dropship-view/dropship-view.component.html")
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_script_loader_service__WEBPACK_IMPORTED_MODULE_5__["ScriptLoaderService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"], _auth_services_dropship_service__WEBPACK_IMPORTED_MODULE_2__["DropshipService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
...
/* harmony import */ var _dropship_view_dropship_view_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../dropship-view/dropship-view.component */ "./src/app/theme/pages/default/dropship/dropship-view/dropship-view.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: "",
                component: _dropship_view_dropship_view_component__WEBPACK_IMPORTED_MODULE_3__["DropshipViewComponent"]
            }
        ]
    },
];
let DropshipViewModule = class DropshipViewModule {
};
DropshipViewModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_dropship_view_dropship_view_component__WEBPACK_IMPORTED_MODULE_3__["DropshipViewComponent"]]
    })
], DropshipViewModule);
...
//# sourceMappingURL=pages-default-dropship-dropship-view-dropship-view-module-es2015.js.map