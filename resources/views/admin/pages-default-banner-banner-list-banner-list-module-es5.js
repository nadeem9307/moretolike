...
var BannerListComponent = /** @class */ (function () {
    function BannerListComponent(imgBaseUrl, router, toastr, _bannerService, _dataService, formBuilder) {
    ...
    BannerListComponent.prototype.ngOnInit = function () {
        ...
        this._bannerService.getAll().subscribe(function (data) {
            _this.brandData = data.banner;
        });
    };
    BannerListComponent.prototype.brand_delete = function (del_id) {
        var _this = this;
        console.log(del_id);
        var value = confirm('Are u want to delete this brand?');
        if (value) {
            this._bannerService.bannerDelete(del_id).subscribe(function (data) {
                _this.brandData = data.data;
            });
        }
    };
    BannerListComponent.prototype.changeBannerStatus = function (banner) {
        console.log(banner);
...
/* harmony import */ var _banner_list_banner_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../banner-list/banner-list.component */ "./src/app/theme/pages/default/banner/banner-list/banner-list.component.ts");
...
var routes = [
    {
        ...
        children: [
            {
                path: "",
                component: _banner_list_banner_list_component__WEBPACK_IMPORTED_MODULE_3__["BannerListComponent"]
            }
        ]
    },
];
var BannerListModule = /** @class */ (function () {
    function BannerListModule() {
    }
    BannerListModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_banner_list_banner_list_component__WEBPACK_IMPORTED_MODULE_3__["BannerListComponent"]]
        })
    ], BannerListModule);
    return BannerListModule;
}());
...
//# sourceMappingURL=pages-default-banner-banner-list-banner-list-module-es5.js.map