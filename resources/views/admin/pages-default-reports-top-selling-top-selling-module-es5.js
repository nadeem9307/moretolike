...
var TopSellingComponent = /** @class */ (function () {
    function TopSellingComponent(toastr, router, _reportsService, _brandService, _menuService, _categoryService, _productService, _subCategory, _dataService, _script) {
        this.toastr = toastr;
        this.router = router;
    ...
    TopSellingComponent.prototype.search = function () {
        var _this = this;
    ...
    TopSellingComponent.prototype.customer_delete = function (del_id) {
        var _this = this;
        console.log(del_id);
    ...
    TopSellingComponent.prototype.changeStatus = function (customer) {
    ...
    TopSellingComponent.prototype.ngAfterViewInit = function () {
...
var TopSellingModule = /** @class */ (function () {
    function TopSellingModule() {
    }
...
//# sourceMappingURL=pages-default-reports-top-selling-top-selling-module-es5.js.map