...
let SubCategoryListComponent = class SubCategoryListComponent {
    constructor(toastr, _subCategoryService, formBuilder) {
        this.toastr = toastr;
    ...
    ngOnInit() {
        ...
        this._subCategoryService.getAll().subscribe(data => {
        ...
        if (this.form.valid) {
            ...
            this._subCategoryService.getByName(this.form.value.name)
                ...
                if (searchData.success) {
                    this.toastr.error('Sub-category Already Exist', 'Error Message');
                }
                else {
                    this._subCategoryService.createSubCategory({ form_data: this.form.value }).subscribe(data => {
                        this.subCategoryData = data.success;
                        this.menuDrpdown = data.menu;
                        this.toastr.success('Sub-category Added Successfully', 'Success Message');
                        this.reset();
                    });
                }
            });
...
let SubCatgoryListModule = class SubCatgoryListModule {
};
...
//# sourceMappingURL=pages-default-category-sub-category-list-sub-category-list-module-es2015.js.map