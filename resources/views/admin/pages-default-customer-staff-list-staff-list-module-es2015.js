...
/***/ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/customer/staff-list/staff-list.component.html":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/theme/pages/default/customer/staff-list/staff-list.component.html ***!
  \*************************************************************************************************************/
...
let StaffListComponent = class StaffListComponent {
    constructor(_staffService, toastr, router, formBuilder) {
    ...
    ngOnInit() {
        ...
        this.form = this.formBuilder.group({
            f_name: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            l_name: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            email: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            contact_no: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
        });
    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            ...
            console.log(input);
            this._staffService.create(input).subscribe(data => {
                this.toastr.success('Staff Added Successfully', 'Success Message');
                this.reset();
                this.getAll();
            }, (error) => {
                console.log(error);
    ...
    staff_delete(del_id) {
        console.log(del_id);
        let value = confirm('Are you sure to delete this staff request?');
        if (value) {
            this._staffService.del_staff(del_id).subscribe(data => {
                console.log(data);
                this.getAll();
                this.toastr.success('Staff deleted Successfully', 'Success Message');
                //this.customerData = data.data;
            });
        }
    }
    onEdit(staff_id) {
        this._staffService.getById(staff_id).subscribe(data => {
            this.staffDataByid = data.success;
    ...
    onUpdate() {
        ...
        if (this.form1.valid) {
            ...
            this._staffService.update(input, this.staff_id).subscribe(data => {
                this.toastr.success('Staff updated Successfully', 'Success Message');
                this.reset();
                this.getAll();
            }, (error) => {
                console.log(error);
...
StaffListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: __webpack_require__(/*! raw-loader!./staff-list.component.html */ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/customer/staff-list/staff-list.component.html"),
        providers: [_auth_services_staff_service__WEBPACK_IMPORTED_MODULE_2__["StaffService"]]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_auth_services_staff_service__WEBPACK_IMPORTED_MODULE_2__["StaffService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"]])
], StaffListComponent);
...
/* harmony import */ var _staff_list_staff_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../staff-list/staff-list.component */ "./src/app/theme/pages/default/customer/staff-list/staff-list.component.ts");
...
const routes = [
    {
        ...
        children: [
            {
                path: "",
                component: _staff_list_staff_list_component__WEBPACK_IMPORTED_MODULE_3__["StaffListComponent"]
            }
        ]
    },
];
let StaffListModule = class StaffListModule {
};
StaffListModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_staff_list_staff_list_component__WEBPACK_IMPORTED_MODULE_3__["StaffListComponent"]]
    })
], StaffListModule);
...
//# sourceMappingURL=pages-default-customer-staff-list-staff-list-module-es2015.js.map