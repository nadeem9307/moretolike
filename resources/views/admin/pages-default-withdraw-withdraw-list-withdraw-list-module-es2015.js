...
let WithdrawListComponent = class WithdrawListComponent {
    constructor(router, modalService, imgBaseUrl, toastr, _withdrawservice, _dataService, formBuilder) {
        this.router = router;
    ...
    ngOnInit() {
        ...
        /*user permission*/
        this._withdrawservice.getAll().subscribe(data => {
...
let WithdrawListModule = class WithdrawListModule {
};
...
//# sourceMappingURL=pages-default-withdraw-withdraw-list-withdraw-list-module-es2015.js.map