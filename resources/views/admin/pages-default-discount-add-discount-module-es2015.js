...
let AddDiscountComponent = class AddDiscountComponent {
    constructor(_dataService, _productService, _menuService, _categoryService, _subCategory, _script, formBuilder, toastr, router) {
    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            ...
            if (this.currentUser.success.role == 1) {
                ...
                this._productService.createDiscount(input).subscribe(data => {
                    this.reset();
                });
            }
            else {
    ...
    onItemSelect(item) {
        console.log(item);
        this._productService.getProduct(item).subscribe(data => {
            this.productDrpdown = data.success;
...
let AddDiscountModule = class AddDiscountModule {
};
...
//# sourceMappingURL=pages-default-discount-add-discount-module-es2015.js.map