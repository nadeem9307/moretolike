...
/***/ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/vendor/user-add/user-add.component.html":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/theme/pages/default/vendor/user-add/user-add.component.html ***!
  \*******************************************************************************************************/
...
let UserAddComponent = class UserAddComponent {
    constructor(imgBaseUrl, formBuilder, router, toastr, route, _dataService, _userService) {
    ...
    ngOnInit() {
        ...
        this.form = this.formBuilder.group({
            ...
            contact: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            ...
            zipcode: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            facebook: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            google_plus: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            twitter: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            linkedin: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            youtube: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            instagram: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            flicker: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            role: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]
        });
        this._userService.getUserRoleAll().subscribe(data => {
            this.userRole = data.success;
        });
        ...
        this.route.params.subscribe(params => {
            ...
            this._userService.getById(params.id).subscribe(data => {
                console.log(data);
                this.vendorDetails = data.success;
            });
        });
    }
    isFieldValid(field) {
    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            ...
            this._userService.create(input).subscribe(data => {
                this.toastr.success('User Added Successfully', 'Success Message');
                this.reset();
            }, (error) => {
                console.log(error);
                console.log('error');
...
UserAddComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: __webpack_require__(/*! raw-loader!./user-add.component.html */ "./node_modules/raw-loader/index.js!./src/app/theme/pages/default/vendor/user-add/user-add.component.html")
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_script_loader_service__WEBPACK_IMPORTED_MODULE_4__["ScriptLoaderService"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"], _services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"], _auth_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]])
], UserAddComponent);
...
/* harmony import */ var _user_add_user_add_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../user-add/user-add.component */ "./src/app/theme/pages/default/vendor/user-add/user-add.component.ts");
...
let UserAddModule = class UserAddModule {
};
UserAddModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _layouts_layout_module__WEBPACK_IMPORTED_MODULE_6__["LayoutModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_8__["NgxPaginationModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"],
        ],
        declarations: [_user_add_user_add_component__WEBPACK_IMPORTED_MODULE_3__["UserAddComponent"]],
    })
], UserAddModule);
...
//# sourceMappingURL=pages-default-vendor-user-add-user-add-module-es2015.js.map