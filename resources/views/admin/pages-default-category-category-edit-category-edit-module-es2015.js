...
let CategoryEditComponent = class CategoryEditComponent {
    constructor(toastr, _categoryService, _menuService, route, router, formBuilder) {
        this.toastr = toastr;
    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            if (params.category_id) {
                ...
                this._categoryService.getById(params.category_id).subscribe(data => {
    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            let that = this;
            this._categoryService.updateCategory({ form_data: this.form.value }).subscribe(data => {
...
let CategoryEditModule = class CategoryEditModule {
};
...
//# sourceMappingURL=pages-default-category-category-edit-category-edit-module-es2015.js.map