...
<div class="container content mrgtp">
  <!--list profile-->
	...
	<div class="row shop-margin">
        ...
        <!--left menu end-->
        <div class="col-md-9">
            <h2>Searching for {{$data['search_key']}}</h2>
            <small>Showing {{count($data['product'])}} results</small>
            <div class="row">
                <div class="col-sm-12">
                    <ul class="search-shop">
                        <li>
                            <input type="text" class="form-control" placeholder="Search product..." id="keywords" name="s" value="{{$data['search_key']}}">
            ...
            <div class="row filteted_row" style="padding: 15px 10px 0px 30px;">
    ...
    <section>
         ...
         <div class="row tabmenu-line">
            <div class="col-md-6">
               <h2 class="popular">Recomended Product</h2>
            </div>
            <div class="col-md-6">
            </div>
         </div>
         ...
         <div id="demo1" class="is-relative">
            ...
            <div class="no-padding my-5 products-carousel swiper-container">
               <div class="swiper-wrapper">
                  @foreach(json_decode($recomended) as $row)
                              ...
                              <div class="col-header">
                                 <div class="price-top">
                                    <a href="javascript:void(0);" class="show-tt1" data-toggle="tooltip{{$row->product_id}}" data-html="true" title='<div class="tooltip_s"><p  productid="{{$row->product_id}}"  class="close tooltipClose1"><i class="fa fa-close"></i></p>
                                       <br>
                                       <span class="text1">Add this product to your Store you earn {{$row->vendor_commission}} <?=$row->vendor_commission_type == 'percentage' ? '%' : 'flat'?> on each sale.
                                 ...
                                 <div class="price-right">
                                    <h5>
                                       @if(is_array(Session::get('compare_id')) && in_array($row->product_id, Session::get('compare_id')))
                                          <a href="javascript:void(0)" id="compare_{{$row->product_id}}" class="cursor-pointer">
