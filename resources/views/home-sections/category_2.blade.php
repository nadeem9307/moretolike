...
<section class="home-v1-recently-viewed-products-carousel section-products-carousel animate-in-view fadeIn animated" data-animation="fadeIn">
  <header>
    <div class="row">
      <div class="col-sm-6"><h2 class="h1">Trending products</h2></div>
     
      <div class="col-sm-6"><a href="/daily-deals-section"><p style=" margin-bottom: 0px;padding-top: 15px;font-size: 14px;text-align: right;">Go to Daily Deals Section <i class="fa fa-angle-right"></i></p></a></div>
    </div>
    
    <div class="owl-nav"> 
      <a href="#products-carousel-prev" data-target="#recently-added-products-carousel2" class="slider-prev">
      <i class="fa fa-angle-left "></i></a> 
      <a href="#products-carousel-next" data-target="#recently-added-products-carousel2" class="slider-next">
      <i class="fa fa-angle-right "></i></a> </div>
  </header>
  <div id="recently-added-products-carousel2" class="row">
            ...
            <div class="product-inner">
             ...
             <!-- <a href="javascript:void(0);" class="showtt" data-toggle="tooltip_s{{$value->product_id}}" data-html="true" title='<div class="tooltip_1"><p  productid="{{$value->product_id}}" style="text-align:right; color: white; font-size: 10px; font-weight: 400; position: absolute;top: 10px;  right: 15px;color:#ffffff" class="close tooltipClose1">x</p>Add this product to your Store you earn 15% on each sale.<br><br>This product is delivered by:<br><span class="undeline">Superstore</span> <span class="ftrt"> <a href="product-details/{{$value->slug}}">Click to add..</a></span></div>'> </a> -->
                ...
                <div class="hover-area" style="border: none;">
                  ...
                  <div class="col-md-6">
                    <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-3 images" data-columns="1">
                      <div class="">
                        <figure class="woocommerce-product-gallery__wrapper">
                          <div data-thumb="{{getenv('URL')}}{{$value->product_img}}" class="woocommerce-product-gallery__image">
                            <a href="{{getenv('URL')}}{{$value->product_img}}" data-fancybox="gallery-719" style="overflow: hidden;">
                              <img width="600" height="550" src="{{getenv('URL')}}{{$value->product_img}}" class="attachment-shop_single size-shop_single wp-post-image eilandscape" alt="" title="" data-src="{{getenv('URL')}}{{$value->product_img}}" data-large_image="{{getenv('URL')}}{{$value->product_img}}" data-large_image_width="720" data-large_image_height="660" srcset="{{getenv('URL')}}{{$value->product_img}} 600w, {{getenv('URL')}}{{$value->product_img}} 300w,{{getenv('URL')}}{{$value->product_img}} 720w" sizes="(max-width: 600px) 100vw, 600px">
                            </a>
