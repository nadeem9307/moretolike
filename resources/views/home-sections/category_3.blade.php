@if(count($featured_product_slider) > 0)
  ...
  <header>
   <div class="row">
      ...
      <div class="col-sm-6 tabmar">
        <a href="javascript:void(0)" class="brdmenu" onclick="shortProduct('*', 'featured_product_slider')">Top 20 </a> 
        <?php $i = 1;?>
        @foreach($sub_category as $row) 
          @if($i < 8 )
          <a href="javascript:void(0)" class="brdmenu1" onclick="shortProduct({{$row->id}}, 'featured_product_slider')">{{$row->name}}</a>
          @endif
          <?php $i++; ?>
        @endforeach
      </div>
    ...
    <div class="owl-nav"> 
      <a href="#products-carousel-prev" data-target="#popular_products" class="slider-prev">
      <i class="fa fa-angle-left"></i></a> 
      <a href="#products-carousel-next" data-target="#popular_products" class="slider-next">
      <i class="fa fa-angle-right"></i></a> </div>
  </header>
  <div id="popular_products" class="row">
   <div class="col-lg-12 col-md-12">
      <div class="products owl-carousel recently-added-products products-carousel columns-6" id="featured_product_slider">
        <!-- repeat code will placed here -->
        @foreach($featured_product_slider as $key=>$value)

        <div class="product category3 featured_product_slider">
          ...
          <div class="product-outer">
            <div class="product-inner">
             ...
             @endif
            <!--  <a href="javascript:void(0);" class="showtt" data-toggle="tooltip_s1{{$value->product_id}}" data-html="true" title='<div class="tooltip_1"><p  productid="{{$value->product_id}}" style="text-align:right; color: white; font-size: 10px; font-weight: 400; position: absolute;top: 10px;  right: 15px;color:#ffffff" class="close tooltipClose2">x</p>Add this product to your Store you earn 15% on each sale.<br><br>This product is delivered by:<br><span class="undeline">Superstore</span> <span class="ftrt"> <a href="product-details/{{$value->slug}}">Click to add..</a></span></div>'> </a> -->

                  <span class=""><a href="javascript:void(0);" class="show-tt2" productid="{{$value->product_id}}">
